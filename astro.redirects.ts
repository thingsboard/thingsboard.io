...
export const redirects: AstroUserConfig['redirects'] = {
	...
	// Device Library — old per-platform URLs (487 entries) → flat slug + ?platform=X
	// Generated by scripts/migrate-device-library/. Re-run pnpm migrate:device-library to refresh.
