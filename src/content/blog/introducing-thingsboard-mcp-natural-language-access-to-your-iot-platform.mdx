...
description: 'ThingsBoard MCP lets AI assistants query the ThingsBoard API in natural language — list devices, fetch telemetry, manage alarms, no manual REST calls.'
date: 2025-10-03
...
![ThingsBoard MCP architecture for natural-language IoT control](/images/blog/introducing-thingsboard-mcp-natural-language-access-to-your-iot-platform/scheme2.svg)
...
![ThingsBoard interface before MCP integration](/images/blog/introducing-thingsboard-mcp-natural-language-access-to-your-iot-platform/before.webp)
...
![ThingsBoard interface with MCP natural-language access enabled](/images/blog/introducing-thingsboard-mcp-natural-language-access-to-your-iot-platform/after-1.webp)
...
- Download from [Anthropic](https://claude.com/download) and install on your system.
