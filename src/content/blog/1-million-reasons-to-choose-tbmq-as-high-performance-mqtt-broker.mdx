...
With Redis and Lettuce fully integrated, the next challenge was ensuring TBMQ’s ability to handle large-scale P2P messaging in a distributed environment. To simulate real-world conditions, we deployed [TBMQ on AWS EKS (Elastic Kubernetes Service)](/docs/mqtt-broker/installation/cluster/aws-cluster-setup/), allowing us to dynamically scale and stress-test the system.
