...
This release brings a range of meaningful enhancements, each designed to improve the system’s transparency, security, and performance, paving the way for a more reliable and efficient MQTT experience. We invite you to try out these powerful new features by [installing the latest version of TBMQ](https://tbmq.io/docs/installation/).
