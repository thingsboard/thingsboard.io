...
description: 'Cut long-term telemetry storage cost in ThingsBoard with aggregation and explicit data retention rules — telemetry lifecycle recipes for production scale.'
date: 2026-01-20
...
![Telemetry chart showing aggregated readings over time](/images/blog/efficient-aggregation-and-data-retention-in-thingsboard/chart-2.webp)
...
![Telemetry data types overview in ThingsBoard platform](/images/blog/efficient-aggregation-and-data-retention-in-thingsboard/telemetry_types-2.webp)
...
![Data aggregation flow in ThingsBoard time-series processing](/images/blog/efficient-aggregation-and-data-retention-in-thingsboard/aggregation-6.webp)
...
![Aggregation and retention strategy diagram in ThingsBoard](/images/blog/efficient-aggregation-and-data-retention-in-thingsboard/aggregation_retention-4.webp)
...
![Data retention strategy configuration in ThingsBoard](/images/blog/efficient-aggregation-and-data-retention-in-thingsboard/retention_strategy-1.webp)
...
![Daily energy consumption widget in ThingsBoard dashboard](/images/blog/efficient-aggregation-and-data-retention-in-thingsboard/daily_consumption-2.webp)

- **Monthly aggregation (from daily telemetry)**: Calculates monthly totals using already aggregated daily values.

![Monthly consumption analytics widget in ThingsBoard](/images/blog/efficient-aggregation-and-data-retention-in-thingsboard/monthly_consumption-2.webp)

You may find the prepared calculated field JSON files for both aggregation levels below:

- <a href="/resources/blog/daily_consumption.json" download="daily_consumption.json">**Daily aggregation calculated field**</a>
- <a href="/resources/blog/monthly_consumption.json" download="monthly_consumption.json">**Monthly aggregation calculated field**</a>
...
![Saving time-series data to ThingsBoard storage scheme](/images/blog/efficient-aggregation-and-data-retention-in-thingsboard/save_time_series.webp)
...
![Data volume reduction through aggregation in ThingsBoard](/images/blog/efficient-aggregation-and-data-retention-in-thingsboard/data_volume-2.webp)
