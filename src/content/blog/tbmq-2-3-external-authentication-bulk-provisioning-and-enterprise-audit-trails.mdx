...
Configuration parameters are described in the [TBMQ configuration reference](/docs/mqtt-broker/install/config/#redis-configuration-parameters).
...
<BlogCTA
  ...
  buttons={[
    ...
    { text: "Upgrade from CE", href: "/docs/mqtt-broker/install/upgrade-instructions/", variant: "outline" }
  ]}
/>
