...
We're excited to introduce [TBMQ Professional Edition](https://tbmq.io/docs/pe/) (TBMQ PE) – the next step in the evolution of our MQTT broker. TBMQ PE is built on top of [TBMQ's](https://tbmq.io/) proven, production-ready core and adds advanced features for security, observability, integration, and professional support. Starting with this release, the existing open-source version will be known as [TBMQ Community Edition](https://tbmq.io/docs/) (TBMQ CE).
...
<BlogCTA
  ...
  buttons={[
    { text: "Upgrade", href: "https://tbmq.io/docs/installation/upgrade-instructions/" },
...
Check out our [Single Sign-On (SSO) / OAuth2](https://tbmq.io/docs/pe/security/oauth-2-support/) guide.
...
Check out our [RBAC](https://tbmq.io/docs/pe/security/rbac/) guide.
...
Check out our[ ](https://tbmq.io/docs/pe/security/rbac/)[White labeling](https://tbmq.io/docs/pe/white-labeling/) guide.
