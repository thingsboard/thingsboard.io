...
<img src="/src/assets/devices-library/seeed/seeed-grove-demo.gif" alt="Grove Base Hat dashboard demo" style="width: 100%; margin: 1rem 0;" />
...
<Steps>
1. Follow the <a href="http://wiki.seeedstudio.com/Grove_Base_HAT/" target="_blank" rel="noopener noreferrer">Grove Base HAT configuration guide</a> to set up the Raspberry Pi.
