...
To enable batch mode, select **Batch** in the **FIELD TYPE** dropdown in the <DocLink product={props.product} path="trendz/calculations/overview">Calculated Field</DocLink> Function tab.
