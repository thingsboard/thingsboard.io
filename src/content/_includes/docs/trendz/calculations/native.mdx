...
- The same result can be achieved with a Simple or <DocLink product={props.product} path="TODO">Batch</DocLink> Calculation — those execute faster because Trendz handles data loading and aggregation internally.
