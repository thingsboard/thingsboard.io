...
| **Custom Model** | Arbitrary multivariable predictions using any Python library; you supply the model source and Trendz handles data injection and output processing. On self-hosted installations you can install additional Python packages to extend the available libraries. |
