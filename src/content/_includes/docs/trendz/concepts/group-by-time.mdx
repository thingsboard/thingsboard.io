...
To show how data changes over time, drag the **Date** field from the left panel onto the **X-axis** section of a view. Trendz will split the selected time range into intervals and apply the configured aggregation function to the data in each interval.

## RAW Mode (User-Controlled Granularity)
...
## Fixed Date Aggregation Options
...
| **START_OF_WEEK** | First day of the calendar week | `2020-03-01` |
| **WEEK_OF_YEAR** | Week number within the year (1–54) | `10` |
