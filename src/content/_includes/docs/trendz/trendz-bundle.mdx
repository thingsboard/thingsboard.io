...
See <DocLink product={props.product} path="installation/ubuntu#step-6-sync-thingsboard-with-trendz">Step 6 of the installation guide</DocLink> for connection instructions.
