...
| Property | Env variable | Default | Description |
|----------|-------------|---------|-------------|
| `license.secret` | `TRENDZ_LICENSE_SECRET` | *(empty)* | License secret obtained from the ThingsBoard License Portal |
...
Controls background job scheduling. See <a href="../tasks-service">Task Service</a> for the full job reference.
