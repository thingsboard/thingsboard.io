...
We recommend using valid SSL certificates generated using trusted CA authorities and avoiding spending time on resolving issues with [self-signed certificates](#self-signed-certificates-generation).
...
- `LISTENER_SSL_PROTOCOL` — SSL protocol name. Default value is `TLSv1.2`. See the [Java documentation](https://docs.oracle.com/en/java/javase/17/docs/specs/security/standard-names.html#sslcontext-algorithms) for more details.
