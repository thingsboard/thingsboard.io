...
- **White labeling** — TBMQ uses the domain to apply custom branding to the login page (logos, titles, and colors).
...
2. **Register the domain in TBMQ**
   ...
   <ImageGallery images={[
     {
       src: '/src/assets/images/docs/mqtt-broker/pe/security/adding-new-domain-1.png',
     ...
     {
       src: '/src/assets/images/docs/mqtt-broker/pe/security/adding-new-domain-2.png',
       alt: 'Enter the domain name and click Add',
       caption: 'Enter a valid domain name in the "Domain name" field and click "Add".',
     },
     {
       src: '/src/assets/images/docs/mqtt-broker/pe/security/adding-new-domain-3.png',
...
<ImageGallery images={[
  {
    src: '/src/assets/images/docs/mqtt-broker/pe/security/domain-login-1.png',
...
<ImageGallery images={[
  {
    src: '/src/assets/images/docs/mqtt-broker/pe/security/domain-details-1.png',
  ...
  {
    src: '/src/assets/images/docs/mqtt-broker/pe/security/domain-details-2.png',
...
<ImageGallery images={[
  {
    src: '/src/assets/images/docs/mqtt-broker/pe/security/delete-domain-1.png',
    alt: 'Click the Delete button on the Domains tab',
    caption: 'To delete the domain click "Delete" button on the "Domains" tab.',
  },
  {
    src: '/src/assets/images/docs/mqtt-broker/pe/security/delete-domain-2.png',
...
- [Amazon Route 53](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/resource-record-sets-values.html)
- [GoDaddy](https://www.godaddy.com/help/add-an-a-record-19238)
- [Cloudflare](https://developers.cloudflare.com/dns/manage-dns-records/how-to/create-dns-records/)
- [ClouDNS](https://www.cloudns.net/wiki/article/10/)
...
Use the [Google Admin Toolbox DIG](https://toolbox.googleapps.com/apps/dig/) or run the following command on Linux:
...
If the configuration appears correct but the issue persists, please [contact us](https://thingsboard.io/docs/pe/mqtt-broker/help/) for further assistance.
