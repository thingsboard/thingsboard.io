...
- <DocLink product={props.product} path="user-guide/ui/settings/#connectivity">**Connectivity settings**</DocLink> — Learn how to configure hosts and ports in the TBMQ UI for use in different protocol-based features.
