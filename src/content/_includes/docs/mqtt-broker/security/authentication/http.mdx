...
For convenience, you can utilize the <DocLink product={props.product} path="user-guide/ui/mqtt-client-credentials/#check-connectivity">Check connectivity tool</DocLink> within the TBMQ interface to automatically generate the required subscribe and publish commands.
