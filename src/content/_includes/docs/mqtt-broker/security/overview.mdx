...
- `failure` — the provider recognized the credentials but rejected them (for example, a wrong password); the connection is rejected immediately without trying subsequent providers.
