...
<ImageGallery product={props.product} images={[
  { src: '/src/assets/images/docs/mqtt-broker/integrations/tbmq-ie-main.png', alt: 'TBMQ integrations high-level design', caption: 'TBMQ integrations high-level design' },
]} />
