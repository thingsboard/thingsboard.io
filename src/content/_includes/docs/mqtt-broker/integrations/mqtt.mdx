...
TBMQ MQTT Integration enables forwarding messages to **external MQTT brokers**, allowing real-time data delivery to third-party platforms. Typical use cases:
...
<ImageGallery images={[
  ...
  { src: '/src/assets/images/docs/mqtt-broker/pe/user-guide/ui/send-mqtt-message-2.png', alt: 'Set topic to tbmq/mqtt-integration and click Send' },
]} />
