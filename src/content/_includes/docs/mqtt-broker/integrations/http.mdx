...
TBMQ HTTP Integration provides a simple way to forward MQTT messages from devices to an external system using the HTTP protocol.
...
- An external service ready to receive HTTP requests (e.g., [ThingsBoard Cloud](https://thingsboard.io/docs/paas/getting-started-guides/what-is-thingsboard-cloud/)).
...
Follow the [ThingsBoard HTTP Integration Guide](https://thingsboard.io/docs/paas/user-guide/integrations/http/) to create an integration on ThingsBoard Cloud.
