...
TBMQ Kafka Integration enables seamless communication with **Apache Kafka**, allowing TBMQ to publish messages to external Kafka clusters. Typical use cases:
  ...
  <TabItem label="Confluent Cloud">
    **Step 1:** In Confluent, open your environment → **Cluster** → **Cluster settings**. Find the **Bootstrap server** URL (format: `URL_OF_YOUR_BOOTSTRAP_SERVER:9092`) and copy it to the integration.
    ...
    <ImageGallery images={[
      ...
      { src: '/src/assets/images/docs/mqtt-broker/pe/user-guide/ui/kafka-integration-cloud-server-2.png', alt: 'Paste bootstrap server URL into TBMQ Kafka integration' },
    ]} />
    ...
    **Step 2:** Add the following **Other properties** key-value pairs for SASL/SSL authentication:
    ...
    <ImageGallery images={[
      ...
      { src: '/src/assets/images/docs/mqtt-broker/pe/user-guide/ui/kafka-integration-cloud-properties-4.png', alt: 'Add security.protocol property' },
    ]} />
...
<ImageGallery images={[
  ...
  { src: '/src/assets/images/docs/mqtt-broker/pe/user-guide/ui/send-uplink-message-kafka-1.png', alt: 'Set topic to tbmq/kafka-integration and click Send' },
...
| `eventType` | Type of MQTT event (`PUBLISH_MSG`). |
