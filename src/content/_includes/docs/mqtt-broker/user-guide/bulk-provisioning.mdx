...
3. **Map columns**
   ...
   Map each CSV column to a credential field. Supported types:
...
- **To update a field:** provide a new value in the corresponding CSV column (see the password policy below).
