...
<ImageGallery images={[
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/unauthorized-clients-1.png', alt: 'Unauthorized Clients table showing failed connection attempts' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/unauthorized-clients-2.png', alt: 'Filter window for the Unauthorized Clients table' },
]} />
...
<ImageGallery images={[
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/delete-unauthorized-client-1.png', alt: 'Click Delete icon next to the unauthorized client to delete it' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/delete-unauthorized-client-2.png', alt: 'Click Delete icon in the top right corner to delete all unauthorized clients' },
]} />
