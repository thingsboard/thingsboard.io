...
<ImageGallery images={[
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/session-details-1.png', alt: 'Navigate to Sessions page and click on a table row' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/session-disconnect-1.png', alt: 'Click Disconnect client button to disconnect a connected client' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/session-remove-1.png', alt: 'Click Remove session button to delete a disconnected session' },
]} />
...
- **Clean Start** — if true, the broker discards any previous session and starts a new one.
...
- **Client Credentials** — the authentication source used for this session. Dynamically labeled as
  [Basic](<DocLink product={props.product} path="security/authentication/basic" />),
  [X.509](<DocLink product={props.product} path="security/authentication/x509" />), or
...
- **Retain Handling** — how the broker handles retained messages at subscription time (0/1/2).
...
<ImageGallery images={[
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/session-subscriptions-1.png', alt: 'List of subscriptions for the session' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/session-subscriptions-2.png', alt: 'MQTT 5.0 subscription options' },
]} />
...
<ImageGallery images={[
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/session-metrics-1.png', alt: 'Session metrics table with QoS counters. Click Delete icon to clear statistics.' },
]} />
