...
- **Basic** — authentication based on combinations of client ID, username, and password.
  - _Advantages:_ Simple to implement, widely supported, low network overhead.
...
<ImageGallery images={[
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/add-client-credentials-1.png', alt: 'Go to Credentials page and click Add Client Credentials' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/add-client-credentials-2.png', alt: 'Fill in Name and Credentials Type' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/add-client-credentials-3.png', alt: 'Fill in Authentication settings' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/add-client-credentials-4.png', alt: 'Set Authorization rules' },
]} />
...
<ImageGallery images={[
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/change-password-1.png', alt: 'Go to Credentials page, click on the row and click Edit' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/change-password-2.png', alt: 'Click the Change password button' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/change-password-3.png', alt: 'Enter current password, set a new one and click Change password' },
]} />
...
Two options based on the **Use certificate CN regex** parameter:
...
<ImageGallery images={[
  { src: '/src/assets/images/docs/mqtt-broker/features/security-authentication-tls-2.png', alt: 'TLS authentication with Use certificate CN regex disabled — exact CN match' },
  { src: '/src/assets/images/docs/mqtt-broker/features/security-authentication-tls-3.png', alt: 'TLS authentication with Use certificate CN regex enabled — regex CN match' },
]} />
...
{props.product === Products.TBMQ_PE ? (
  <ImageGallery images={[
    { src: '/src/assets/images/docs/mqtt-broker/pe/user-guide/ui/ssl-credentials-authorization.png', alt: 'X.509 credentials authorization rules configuration' },
  ]} />
) : (
  <ImageGallery images={[
    { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/ssl-credentials-authorization.png', alt: 'X.509 credentials authorization rules configuration' },
  ]} />
)}
...
Authorization rules follow the same pattern as Basic credentials.
...
<ImageGallery images={[
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/delete-credentials-1.png', alt: 'Click Delete icon in the credentials row to delete single credentials' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/delete-credentials-2.png', alt: 'Select multiple credentials and click Delete in the top right corner' },
]} />
...
<ImageGallery images={[
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/check-connectivity-1.png', alt: 'Click Check connectivity button on Basic client credentials' },
  { src: '/src/assets/images/docs/mqtt-broker/user-guide/ui/check-connectivity-2.png', alt: 'Select OS, install tools, and copy the generated commands' },
]} />
