...
The interactive [pricing calculator](https://thingsboard.io/pricing/?section=tbmq-options&product=tbmq-private-cloud) lets you define your exact capacity so you only pay for the performance and scale you need.
