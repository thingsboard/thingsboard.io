...
<Aside type="note">
  To explore additional protocols and API options, refer to the <DocLink product={props.product} path='reference/rest-api' target="_blank">ThingsBoard API Reference</DocLink>.
</Aside>
