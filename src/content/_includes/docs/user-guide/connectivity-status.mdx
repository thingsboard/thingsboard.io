...
The Device State service fires four event types into the Rule Engine. You can configure reactions to each using custom <DocLink product={props.product} path='TODO'>rule chains</DocLink>.
