...
| Event | When it fires |
|-------|--------------|
| <DocLink product={props.product} path='TODO'>**Connect**</DocLink> | Device establishes a session (MQTT) or sends any request (HTTP/CoAP) |
| <DocLink product={props.product} path='TODO'>**Disconnect**</DocLink> | Session closes (MQTT) or request completes (HTTP/CoAP) |
| <DocLink product={props.product} path='TODO'>**Activity**</DocLink> | An inactive device sends telemetry, updates attributes, or sends an RPC command |
| <DocLink product={props.product} path='TODO'>**Inactivity**</DocLink> | No activity received within `DEFAULT_INACTIVITY_TIMEOUT` seconds |
