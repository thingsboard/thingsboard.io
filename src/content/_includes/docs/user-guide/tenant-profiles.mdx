...
- Max data points number in rolling arguments — see <DocLink product={props.product} path="user-guide/calculated-fields/#limits--quotas" target="_blank">Calculated Fields — Limits & Quotas</DocLink> for how exceeding this affects a rolling argument's time window.
