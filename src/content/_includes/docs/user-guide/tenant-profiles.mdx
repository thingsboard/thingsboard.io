...
- Max data points number in rolling arguments — see [Calculated Fields — Limits & Quotas](/docs/user-guide/calculated-fields/#limits--quotas) for how exceeding this affects a rolling argument's time window.
