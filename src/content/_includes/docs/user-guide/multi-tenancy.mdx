...
5. Choose the user activation method:
    ...
    - **Send activation mail** — sends the activation link to the specified email address (requires a configured <DocLink product={props.product} path='user-guide/ui/mail-settings'>mail server</DocLink>).
6. Click **Add**.
</Steps>
