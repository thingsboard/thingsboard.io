...
<Steps>
  ...
  3. In **General**, enter a title, specify the entity the field applies to, and select the type **Time series data aggregation**.
  4. Configure [Arguments](#arguments), [Metrics](#metrics), [Aggregation interval](#aggregation-interval), and [Output](#output).
  5. Click **Add** to save.
</Steps>
