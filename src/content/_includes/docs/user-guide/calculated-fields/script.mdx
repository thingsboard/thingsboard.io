...
```plaintext
  ...
  data     72.3    72.9    73.6     NaN    74.1    73.8
            ●───────●───────●───────●───────●───────●

  window 1 ╔══════════════════════╗
  (15 min) ║  72.3   72.9   73.6  ║  .mean() → 72.93
           ╚══════════════════════╝

  window 2          ╔══════════════════════╗
  (slides)          ║  72.9   73.6   NaN   ║  .mean() → 73.25  (NaN ignored)
                    ╚══════════════════════╝
```
...
```plaintext
  ...
  merged[ts3] = { ts: ts3, v1: 73.6, v2: 65 }
                                        ↑ forward-filled from ts2
```
