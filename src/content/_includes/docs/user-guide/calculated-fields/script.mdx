...
<Steps>
  ...
  3. In **General**, enter a title, specify the entity the field applies to, and select the type **Script**.
...
<DocLink product={props.product} path="user-guide/calculated-fields/#output-strategy">Calculated Fields — Output Strategy</DocLink>.
