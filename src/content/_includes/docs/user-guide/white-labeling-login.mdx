...
<Steps>
  ...
  2. Set up your domain configuration:
      ...
      - Fill in the **Base URL** field (this is the base URL for your custom domain)
  3. (Optional) Enable the **Prohibit to use hostname from the client request headers** option (recommended for production environments - this helps prevent security issues related to hostname-based attacks)
...
| **Base URL** | The base URL associated with the domain |

<h4>Security</h4>

| Field | Description |
|-------|-------------|
| **Prohibit to use hostname from the client request headers** | When enabled, prevents the use of hostnames from HTTP headers, which helps mitigate certain security vulnerabilities. Recommended for production environments. |
