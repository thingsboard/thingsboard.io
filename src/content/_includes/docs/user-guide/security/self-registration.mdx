...
|---|---|
| **ThingsBoard PE instance** | A running instance accessible via a public IP address. See <DocLink product={props.product} path="user-guide/install/pe/installation-options">installation options</DocLink> |
...
| **HTTPS** | TLS/SSL configured for your domain (e.g., via Let's Encrypt). See <DocLink product={props.product} path="user-guide/security/http-over-ssl">HTTP over SSL</DocLink> |
...
| Column | Description |
|--------|-------------|
| **Role name** | The <DocLink product={props.product} path="user-guide/rbac">role</DocLink> assigned to the user |
