...
<Aside type="note">
To send emails, a tenant administrator must first configure an <DocLink product={props.product} path="user-guide/ui/mail-settings">outgoing mail server</DocLink>.
</Aside>
