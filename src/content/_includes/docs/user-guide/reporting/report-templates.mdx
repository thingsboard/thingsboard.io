...
Report templates support all standard ThingsBoard entity aliases (as used in dashboards). See <DocLink product={props.product} path="user-guide/aliases">Entity aliases</DocLink> for the full list.
