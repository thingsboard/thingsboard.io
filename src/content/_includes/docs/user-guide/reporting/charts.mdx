...
<DocLink product={props.product === Products.CE ? Products.PE : props.product} path="recipes/reporting-line-chart-temperature">Compare Temperature Across Devices in a Report</DocLink> — step-by-step walkthrough: add a Line chart component to a report template and configure it to compare temperature telemetry from multiple devices over the past 24 hours.
