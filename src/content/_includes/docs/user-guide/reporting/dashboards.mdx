...
<DocLink product={props.product === Products.CE ? Products.PE : props.product} path="recipes/reporting-embed-dashboard">Embed a Dashboard Snapshot in a Report</DocLink> — step-by-step walkthrough: configure a Dashboard component to snapshot the *Environmental Monitor* dashboard and include it in a scheduled report.
