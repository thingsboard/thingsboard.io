...
- <DocLink product={(props.product === Products.PAAS || props.product === Products.PAAS_EU) ? Products.PE : props.product} path='reference/widgets/widget-api' bold={false}>Widget API Reference</DocLink> — comprehensive API reference
