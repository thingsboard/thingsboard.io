...
- <DocLink product={props.product} path='user-guide/contribution/widgets-development/widget-api' bold={false}>Widget API Reference</DocLink> — comprehensive API reference
