...
export const PEOnly = () => (
  <span style={{ display: 'inline-block', background: '#22c55e', color: 'white', padding: '2px 10px', borderRadius: '999px', fontSize: '0.75em', fontWeight: 600, whiteSpace: 'nowrap' }}>PE / Cloud only</span>
);
