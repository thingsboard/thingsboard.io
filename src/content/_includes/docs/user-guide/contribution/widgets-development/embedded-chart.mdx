...
- <DocLink product={props.product} path='user-guide/contribution/widgets-development/widget-api' bold={false}>Widget API Reference</DocLink> — full details on `subscriptionApi`, `createSubscription`, and data structures
