...
- <DocLink product={props.product} path="reference/widgets/cards/markdown-html-card/#example-embedded-dashboard-state-panel" bold={false}>Markdown/HTML Card content panel</DocLink> — reads `subState` and renders the matching embedded dashboard state
</Aside>
