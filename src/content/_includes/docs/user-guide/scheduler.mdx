...
The <DocLink product={props.product} path='reference/widgets/scheduling/scheduler-events/' target="_blank">Scheduler events</DocLink> and <DocLink product={props.product} path='reference/widgets/scheduling/reports-schedule/' target="_blank">Reports schedule</DocLink> widgets (part of the <DocLink product={props.product} path='reference/widgets/widget-library/scheduling/' target="_blank">Scheduling widgets bundle</DocLink>) provide the same capabilities as the Scheduler events page and can be added to any <DocLink product={props.product} path='user-guide/dashboards' target="_blank">Dashboard</DocLink>. The widget also supports custom event types with configurable forms via the **Advanced** tab.
