...
This guide shows how to install ThingsBoard Agent on a remote host and connect it to your ThingsBoard server. To provision many agents at once, use <DocLink product={props.product} path='user-guide/agents/agent-profiles'>auto-provisioning</DocLink> instead.
