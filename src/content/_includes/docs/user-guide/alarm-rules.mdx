...
Propagation controls at which level of the entity hierarchy the alarm becomes visible. For a conceptual overview, see <DocLink product={props.product} path="user-guide/alarms/#alarm-propagation">Alarm propagation</DocLink>.
