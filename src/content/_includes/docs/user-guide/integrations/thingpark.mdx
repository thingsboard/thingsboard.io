...
The decoder parses incoming ThingPark Wireless messages (JSON payload containing `DevEUI_uplink` or `DevEUI_downlink_Sent`) and extracts telemetry such as battery voltage, temperature, GPS position, and device status.
...
<Tabs>
  <TabItem label="TBEL (Recommended)">
    <a href="/resources/docs/integrations/thingspark/thingpark_actility_tbel_uplink_converter.json" download="thingpark_actility_tbel_uplink_converter.json"><strong>thingpark_actility_tbel_uplink_converter.json</strong></a>
  </TabItem>
...
<Tabs>
  <TabItem label="TBEL (Recommended)">
    <a href="/resources/docs/integrations/thingspark/thingpark_actility_tbel_downlink_converter.json" download="thingpark_actility_tbel_downlink_converter.json"><strong>thingpark_actility_tbel_downlink_converter.json</strong></a>
  </TabItem>
  <TabItem label="JavaScript">
...
<Steps>
  <ol start="1">
    ...
    <li>
      ...
      <ul>
        <li>Set <strong>Integration type</strong> to <strong>ThingPark</strong> and enter a name (e.g. "ThingPark integration").</li>
...
<ImageGallery images={[
  { src: '/src/assets/images/user-guide/integrations/thingpark/thingspark-verify-device-connectivity-1.png', alt: 'First telemetry messages received', caption: 'Integration receiving first messages from ThingPark' },
]} />
