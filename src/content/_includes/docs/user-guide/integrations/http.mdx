...
<ImageGallery images={[
  { src: '/src/assets/images/user-guide/integrations/http-integration.svg', alt: 'HTTP integration architecture', caption: 'HTTP integration architecture' },
]} />
