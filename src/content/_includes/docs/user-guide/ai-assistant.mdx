...
<Aside type="note">
  AI Assistant is available to **tenant users only**. Customer accounts do not have access to this feature.
</Aside>
...
<ImageGallery images={[
  {
    src: '/src/assets/images/user-guide/ai-assistant/approval-card.png',
    alt: 'AI Assistant action approval card',
    caption: 'All AI-generated changes require your explicit approval before they are applied. Review the proposed action and click <strong>Approve</strong> to proceed or <strong>Deny</strong> to reject it.',
  },
]} />
...
### Build and Modify Configurations
...
Ask the Assistant to review your current setup without changing anything — list Alarm Rules on a profile, find which Calculated Fields depend on a specific telemetry key, or spot stale thresholds after a data model change.
