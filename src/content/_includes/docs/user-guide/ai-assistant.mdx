    ...
    <ImageGallery images={[
      {
        ...
        caption: 'The AI Credits indicator is in the top-right corner of the Assistant panel. Click it to view your current usage and reset date. The AI Credits pop-up shows your monthly usage, remaining quota, reset date, and an Update button to manage your plan.',
      },
    ]} />
