...
{props.product !== Products.CE && (
  <>
    <ConditionalHeading level={3} id="include-column-in-export">Include column in export</ConditionalHeading>
...
{props.product !== Products.CE && (
  <>
    <ConditionalHeading level={3} id="use-cell-content-function-on-export">Use cell content function on export</ConditionalHeading>
