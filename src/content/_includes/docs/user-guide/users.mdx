...
<Steps>
1. From the sidebar, navigate to **Users**.
...
- **Home dashboard**: The dashboard opened when the user clicks **Home** in the navigation bar. Enable **Hide home dashboard toolbar** to hide the navigation toolbar when this dashboard is open. See <DocLink product={props.product} path="user-guide/dashboards/#home-dashboard">Home Dashboard</DocLink> for the tenant- and customer-wide equivalents.
