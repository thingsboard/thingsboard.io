...
{props.product === Products.PE && (<ul><li><strong>Entity groups</strong> — manage groups, assign and remove entities</li></ul>)}
...
{props.product === Products.PE && (<p><strong>Entity groups</strong> — <em>"List all devices in the 'Production Sensors' group and their online status."</em></p>)}
...
|---|---|---|
| `THINGSBOARD_URL` | ThingsBoard instance base URL | *required* |
