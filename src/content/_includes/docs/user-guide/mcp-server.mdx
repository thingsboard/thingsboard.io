...
- A ThingsBoard account — either on **[ThingsBoard Cloud](/installations/?product=thingsboard-cloud)** or a self-hosted installation.
...
| **Entity groups** | Manage groups, assign and remove entities <ProductBadge>PE only</ProductBadge> |
...
| `THINGSBOARD_TOOLS_GROUP` | Entity groups <ProductBadge>PE only</ProductBadge> | `true` |
