...
- An **MCP-enabled LLM client** — for example, [Claude Desktop](https://claude.com/download), [Claude Code](https://code.claude.com/docs/en/overview), [Cursor](https://www.cursor.com/), VS Code with an MCP extension, or any other client that supports the [Model Context Protocol](https://modelcontextprotocol.io/).
