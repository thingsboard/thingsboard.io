...
<DocLink product={props.product === Products.EDGE_PE ? Products.EDGE_PE : Products.EDGE} path="user-guide/rule-chain-templates">Rule Engine</DocLink> is wrapped
...
Any rule node can produce messages with a custom type string. Custom types are not
listed here — they depend on your rule chain configuration. Use the
<DocLink product={props.product === Products.EDGE_PE ? Products.EDGE_PE : Products.EDGE} path="user-guide/rule-chain-templates">Message Type Switch</DocLink> or
<DocLink product={props.product === Products.EDGE_PE ? Products.EDGE_PE : Products.EDGE} path="user-guide/rule-chain-templates">Message Type Filter</DocLink>
