...
<Aside type="caution">
  ...
  If your data sources produce late-arriving telemetry or you need the ability to re-process historical data, consider using <DocLink product={Products.CE} path="user-guide/calculated-fields/time-series-data-aggregation">Time Series Data Aggregation</DocLink> or <DocLink product={Products.CE} path="user-guide/calculated-fields/related-entities-aggregation">Related Entities Aggregation</DocLink> (Calculated Fields) instead — they aggregate from stored data on demand and are not affected by message ordering or duplicates.
</Aside>
