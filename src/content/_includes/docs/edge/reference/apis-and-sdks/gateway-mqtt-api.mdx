...
This API is used by the open-source <a href="/docs/iot-gateway/what-is-iot-gateway/" target="_blank" rel="noopener noreferrer">ThingsBoard IoT Gateway</a>.
...
The Gateway can publish client-side attributes, request attribute values, and subscribe to shared attribute updates for devices behind it. See <DocLink product={props.product} path="user-guide/attributes" target="_blank">Working with attributes</DocLink> for attribute type details.
