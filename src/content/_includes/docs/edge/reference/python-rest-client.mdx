...
<Aside type="note">
**Deprecated.** Use the <DocLink product={props.product} path='reference/python-client' useTbDocs>new Python REST Client</DocLink> for new projects — auto-generated from the OpenAPI spec and edition-aware. The legacy package still works.
</Aside>
