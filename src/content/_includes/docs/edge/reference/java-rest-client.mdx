...
<Aside type="note">
**Deprecated.** Use the <DocLink product={props.product} path='reference/java-client' useTbDocs>new Java REST Client</DocLink> for new projects — auto-generated from the OpenAPI spec and edition-aware. The legacy library still works.
</Aside>
