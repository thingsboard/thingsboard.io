...
<DocImage src="/src/assets/images/docs/edge/user-guide/device-connectivity.svg" alt="Device connectivity diagram: devices send data over MQTT, HTTP, or CoAP to ThingsBoard Edge, which forwards telemetry and attributes to the ThingsBoard Server when connected" width="800px" />
