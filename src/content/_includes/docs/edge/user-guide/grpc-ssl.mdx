...
For Ubuntu Server, see <a href="/docs/user-guide/install/pe/add-haproxy-ubuntu/#step-6-configure-edge-tls-communication-optional" target="_blank" rel="noopener noreferrer">Step 6: Configure Edge TLS communication</a>.

For CentOS/RHEL Server, see <a href="/docs/user-guide/install/pe/add-haproxy-rhel/#step-6-configure-edge-tls-communication-optional" target="_blank" rel="noopener noreferrer">Step 6: Configure Edge TLS communication</a>.
