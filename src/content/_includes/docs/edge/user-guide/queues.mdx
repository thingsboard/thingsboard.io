...
For a full reference on queue configuration, see <DocLink product={props.product === Products.EDGE_PE ? Products.PE : Products.CE} path="user-guide/rule-engine-2-5/queues" target="_blank">Queues</DocLink>.
