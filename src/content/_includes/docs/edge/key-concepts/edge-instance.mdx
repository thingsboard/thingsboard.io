...
<DocImage src="/src/assets/images/docs/edge/key-concepts/synchronization-architecture.svg" alt="Synchronization architecture diagram: ThingsBoard Edge queues events in PostgreSQL or Kafka and sends them to the server over gRPC with Protocol Buffers" width="800px" />
