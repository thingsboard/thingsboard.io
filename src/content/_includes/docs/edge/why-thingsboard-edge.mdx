...
<img src="/images/edge-and-other-components.svg" alt="Diagram showing the relationship between ThingsBoard Edge, ThingsBoard Server, and IoT Gateway" style="max-width: 100%; height: auto; margin: 1.5rem 0;" />
