...
This page documents the legacy `org.thingsboard:rest-client` library. New projects should use the <DocLink product={props.product} path='reference/java-client'>new Java client</DocLink> — auto-generated from the OpenAPI spec, edition-aware (`thingsboard-ce-client` / `thingsboard-pe-client` / `thingsboard-paas-client`), and actively maintained. The legacy library still works but is no longer recommended for new code.
</Aside>
