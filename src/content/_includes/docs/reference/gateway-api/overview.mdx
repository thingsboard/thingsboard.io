...
<HostCode product={props.product} lang="bash" code={`mosquitto_pub -h "{MQTT_HOST}" -t "v1/gateway/connect" -u "GATEWAY_DEVICE_ACCESS_TOKEN" -m '{"device":"Device A"}'`} />

Connect with a specific device profile:

<HostCode product={props.product} lang="bash" code={`mosquitto_pub -h "{MQTT_HOST}" -t "v1/gateway/connect" -u "GATEWAY_DEVICE_ACCESS_TOKEN" -m '{"device":"Device A","type":"Sensor A"}'`} />
...
<HostCode product={props.product} lang="bash" code={`mosquitto_pub -h "{MQTT_HOST}" -t "v1/gateway/disconnect" -u "GATEWAY_DEVICE_ACCESS_TOKEN" -m '{"device":"Device A"}'`} />
