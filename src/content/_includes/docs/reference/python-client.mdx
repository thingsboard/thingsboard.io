...
<Aside type="note">
The methods in this section are only available in the PE and PaaS editions. See the <DocLink product={props.product} path='user-guide/groups'>Entity Groups</DocLink> and <DocLink product={props.product} path='user-guide/roles'>Roles</DocLink> guides for the underlying concepts.
</Aside>
