...
- <DocLink product={props.product} path='user-guide/cli-extensions'>Deploy with the CLI</DocLink> — every flag of `tb extension deploy`, resource sizes, and the `deployments` commands.
