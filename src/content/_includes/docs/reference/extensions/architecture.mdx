...
| **How to deploy** | <DocLink product={props.product} path='user-guide/cli-extensions'>CLI</DocLink> or REST API | <DocLink product={props.product} path='user-guide/cli-extensions'>CLI</DocLink> or REST API | Docker Compose (`deploy/` folder) |
...
- The image registry must be reachable from the internet. For a private registry, add pull credentials — the registry flags of the <DocLink product={props.product} path='user-guide/cli-extensions#private-registry'>CLI</DocLink>, or `registryAuth` in the deployment API request.
...
The other pages in this section — the <DocLink product={props.product} path='reference/extensions/quickstart'>Quickstart</DocLink> and the <DocLink product={props.product} path='user-guide/cli-extensions'>CLI reference</DocLink> — describe the **managed** path.
