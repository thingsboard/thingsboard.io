...
The ThingsBoard Java REST Client wraps the <DocLink product={props.product} path='reference/rest-api'>REST API</DocLink> and is auto-generated from the OpenAPI spec — every REST endpoint has a typed method. Edition-specific artifacts ensure type-safe access to the right endpoints for your tenant.
...
{props.product !== Products.CE && (<Aside type="note">
