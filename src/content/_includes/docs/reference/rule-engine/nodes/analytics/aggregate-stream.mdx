...
<Aside type="caution" title="Deprecated since 4.4">
  This rule node will be deprecated starting from ThingsBoard 4.4. We recommend using the <DocLink product={props.product} path="user-guide/calculated-fields/time-series-data-aggregation">Time Series Data Aggregation calculated field</DocLink> instead.
</Aside>
