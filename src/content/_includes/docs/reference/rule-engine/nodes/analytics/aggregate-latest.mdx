...
<Aside type="caution" title="Deprecated since 4.4">
  This rule node will be deprecated starting from ThingsBoard 4.4.<br/>We recommend using the <DocLink product={props.product} path="user-guide/calculated-fields/related-entities-aggregation" useTbDocs>Related Entities Aggregation calculated field</DocLink> instead.
</Aside>
