...
A <DocLink product={props.product} path="user-guide/tbel">TBEL</DocLink> or JavaScript script that generates the content for the alarm's `details` field. The script must return a valid JSON value (primitive, array, or object).
