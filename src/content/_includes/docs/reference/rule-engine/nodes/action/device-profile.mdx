...
<Aside type="caution" title="Deprecated since 4.3">
  This rule node has been deprecated starting from ThingsBoard 4.3.<br/>We recommend using the <DocLink product={props.product} path="user-guide/alarm-rules" useTbDocs>Alarm Rules 2.0</DocLink> instead.
</Aside>
