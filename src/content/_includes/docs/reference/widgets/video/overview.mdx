...
The **HLS Video Stream** widget plays any HLS playlist — live or recorded. If you only need VOD, you can skip building a public stream URL entirely: point the widget's **Fallback stream URL** (or your device's stream URL attribute) at any public `.m3u8` URL. Apple's reference stream is a quick way to try it:
