...
<Aside type="note">
When **Display pagination** is disabled, the widget renders up to 1024 requests in a single page instead of paging through the result set. Requests beyond that are not displayed.
</Aside>
