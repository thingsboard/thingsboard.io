...
| The current user has no permission to view scheduler events | Verify the user's role and customer permissions in <DocLink product={props.product} path="user-guide/rbac" bold={false} target="_blank">Roles</DocLink>. |
