...
See also the step-by-step guide: <DocLink product={props.product} path="recipes/solution-templates/swimming-pool-scada-system">Swimming pool SCADA system</DocLink>.
