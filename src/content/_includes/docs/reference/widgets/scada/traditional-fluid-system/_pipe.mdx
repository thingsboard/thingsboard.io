...
|---|---|---|
| **Fluid presence** | `Absent` | Whether fluid is present in the pipe. |
| **Flow presence** | `Absent` | Whether fluid is flowing through the pipe. |
| **Flow direction** | `Forward` | Direction of the fluid flow animation. |
| **Flow animation speed** | `1` | Speed of the flow animation. `1` is normal speed, `0` disables animation, negative values reverse it. |
| **Leak** | `False` | Whether a leak is present on the pipe. |
