...
It represents a motor pump with color-coded running, warning, and critical states.
...
|---|---|---|---|
| **Running** | `Use attribute 'running'` | `True`, `False` | Whether the pump is currently running. |
