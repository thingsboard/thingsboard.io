...
|---|---|---|---|
| **Running** | `Use attribute 'running'` | `True`, `False` | Whether the pump is currently running. When `True`, the impeller rotation animation plays. |
...
| **Rotation animation speed** | `1` | number | Speed of the impeller rotation animation. `1` is normal speed, `0` disables animation, `< 1` - slower animation, `> 1` - faster animation. |
