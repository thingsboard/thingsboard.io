...
It represents a single residential or commercial building connected to a utility network — electricity, gas, water, or district heating. The widget shows whether building systems are currently active (running state) and highlights warning or critical conditions with configurable colors and a blinking animation. Use it on smart building, energy management, home automation, or smart grid dashboards to visualize individual premises, surface supply or consumption alerts, and drill into a building's detail view with a single click.
