...
It represents a multi-story residential apartment building connected to a utility network — electricity, gas, water, or district heating. The widget shows whether the building is actively being supplied or its systems are running (running state) and highlights warning or critical conditions with configurable colors and a blinking animation. Use it on smart building, district energy, utility management, or smart city dashboards to represent large residential blocks, track supply status across a building portfolio, and navigate to per-building detail views with a single click.
