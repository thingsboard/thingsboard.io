...
Add <DocLink product={props.product} path="user-guide/widgets/#filters" bold={false} target="_blank">filters</DocLink> to narrow the counted set — for example, only devices where the `active` attribute equals `true`.
