...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/reference/widgets/buttons/command-button/ventilation-restart-button.png', alt: 'Ventilation restart Command button widget on dashboard', caption: 'The Restart Ventilation Command button widget on the dashboard.', products: [Products.CE] },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/reference/widgets/buttons/command-button/example-command-button-1-ce.png', alt: 'On click behavior configured — Execute RPC restartVentilation', caption: 'On click: Execute RPC method restartVentilation with persistent RPC enabled.', products: [Products.CE] },
  { src: '/src/assets/images/reference/widgets/buttons/command-button/example-command-button-2-ce.png', alt: 'Disabled state configured — Get attribute active equals false', caption: 'Disabled state: Get attribute active (Shared) — disabled when value is false.', products: [Products.CE] },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/reference/widgets/buttons/command-button/example-command-button-3-ce.png', alt: 'Button appearance configured — Outlined layout, blue color', caption: 'Button appearance: Outlined layout, Restart Ventilation label, restart_alt icon, blue color palette.', products: [Products.CE] },
]} />
...
<MultiProductImageGallery product={props.product} images={[
  { src: '/src/assets/images/reference/widgets/buttons/command-button/example-command-button-4-ce.png', alt: 'Command button in enabled state — blue, active = true', caption: 'When active = true: button is blue and clickable.', products: [Products.CE] },
  { src: '/src/assets/images/reference/widgets/buttons/command-button/example-command-button-5-ce.png', alt: 'Command button in disabled state — gray, active = false', caption: 'When active = false: button is gray and non-clickable.', products: [Products.CE] },
]} />
