...
2. Go to **Resources → Resource library** and click **+**.
3. Upload one or more LwM2M model XML files.
</Steps>

Download the latest models from the [official OMA registry on GitHub](https://github.com/OpenMobileAlliance/lwm2m-registry). Upload all models whose versions match the objects your devices will use.
