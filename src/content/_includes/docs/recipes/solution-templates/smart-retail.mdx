...
Additional <DocLink product={props.product} path='user-guide/ui/customers'>customers</DocLink> and <DocLink product={props.product} path='user-guide/ui/users'>users</DocLink> can be created via the administration UI. See <DocLink product={props.product} path='user-guide/rbac'>advanced RBAC</DocLink> for more information.
