...
The solution uses three <DocLink product={props.product} path='user-guide/rule-engine-2-0/overview'>rule chains</DocLink> to process telemetry from gateways and devices:
...
You can find the generated administrator credentials in the solution instructions. Additional <DocLink product={props.product} path='user-guide/ui/customers'>customers</DocLink> and <DocLink product={props.product} path='user-guide/ui/users'>users</DocLink> can be created via the administration UI.
