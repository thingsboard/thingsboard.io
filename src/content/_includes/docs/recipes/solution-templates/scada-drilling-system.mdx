...
The solution automatically configures the IoT Gateway and creates five drilling devices via the <a href="/docs/iot-gateway/">ThingsBoard IoT Gateway</a> with the <a href="/docs/iot-gateway/config/modbus/"><b>Modbus connector</b></a>:
