...
Download the setup file and <DocLink product={props.product} path="user-guide/bulk-provisioning" target="_blank">import</DocLink> it before running the examples:
