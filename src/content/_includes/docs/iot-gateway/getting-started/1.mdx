...
<Steps>
1. Select and click on the newly created gateway, then click on the **Launch command** button in the top right corner.
...
2. Click to download `docker-compose.yml` file to your PC, copy the command and execute it in your terminal.
