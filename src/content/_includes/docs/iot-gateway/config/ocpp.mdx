...
<Aside type="note">
  Also, the connector has built-in GET and SET RPC methods for reading and writing any OCPP component/variable. See <DocLink product={props.product} path="features/reserved-rpc/">the guide</DocLink>.
</Aside>
