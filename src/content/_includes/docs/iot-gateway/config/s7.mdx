...
<Aside type="note">
  _The S7 connector supported by the gateway version 3.8.5 and higher._
...
| `devices[].heartbeatInterval` | 5 | Heartbeat interval in seconds. |
...
ThingsBoard. See [user guide](/docs/pe/user-guide/digital-twins/attributes/#attribute-scopes) for more details.
...
ThingsBoard allows sending [RPC commands](/docs/pe/reference/mqtt-api/rpc/) to the device that is connected
