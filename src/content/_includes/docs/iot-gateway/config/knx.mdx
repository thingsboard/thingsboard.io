...
<DocLink product={props.product} path="iot-gateway/config/general">General Configuration</DocLink> reference.
...
<DocLink product={props.product} path="iot-gateway/features/reserved-rpc">Reserved RPC methods</DocLink> guide for details.
