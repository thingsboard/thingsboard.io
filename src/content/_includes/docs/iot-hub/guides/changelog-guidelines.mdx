...
Pair every entry with a <a href="https://semver.org/" target="_blank" rel="noopener noreferrer nofollow"><strong>semantic version</strong></a> bump — **patch** (`1.0.1`) for fixes, **minor** (`1.1.0`) for backward-compatible features, **major** (`2.0.0`) for breaking changes.
