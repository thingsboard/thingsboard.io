...
<Aside type="note">
  For pre-1.7.x configuration, see the <a href={props.product === Products.MOBILE_PE ? '/docs/mobile/pe/app-icon-splash-screen-before-v1-7/' : '/docs/mobile/app-icon-splash-screen-before-v1-7/'}>pre-1.7.x app icon and splash screen guide</a>.
</Aside>
...
<DocImage
  src="/src/assets/images/mobile/app-icon-splash-screen/splash_screen_sizes_template.png"
  alt="Splash screen icon size layout showing safe zones for both variants"
  width="60%"
/>
