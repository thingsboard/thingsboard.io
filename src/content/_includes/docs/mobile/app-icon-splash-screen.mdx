...
<Aside type="note">
  For pre-1.7.x configuration, see the <DocLink product={props.product} path="app-icon-splash-screen-before-v1.7">pre-1.7.x app icon and splash screen guide</DocLink>.
</Aside>
...
Configure app icons in `pubspec.yaml`. For details, see the [flutter_launcher_icons documentation](https://pub.dev/packages/flutter_launcher_icons).
...
<Aside type="note">
  `flutter_native_splash` has extensive configuration options. For details, see the [official documentation](https://pub.dev/packages/flutter_native_splash).
</Aside>
