...
For full details on Flutter's internationalization system, see the official [Internationalizing Flutter apps](https://docs.flutter.dev/ui/accessibility-and-internationalization/internationalization) guide.
...
4. **Generate localization files.**
   ...
   **App version 1.7.0 and later** — install the **Flutter Intl** extension, which automatically tracks localization changes and regenerates files:
   ...
   - [VS Code — Flutter Intl extension](https://marketplace.visualstudio.com/items?itemName=localizely.flutter-intl)
   - [IntelliJ / Android Studio — Flutter Intl plugin](https://plugins.jetbrains.com/plugin/13666-flutter-intl)
...
- Open a pull request to the {props.product === Products.MOBILE_PE
    ? '[flutter_thingsboard_pe_app](https://github.com/thingsboard/flutter_thingsboard_pe_app)'
    : '[flutter_thingsboard_app](https://github.com/thingsboard/flutter_thingsboard_app)'} repository with your new or updated `.arb` files.
