...
- First download the <a href="/device-library/resources/dashboards/microcontrollers/camera/dashboard.json" target="_blank" rel="noopener noreferrer" download="dashboard.json">Check and control device data dashboard</a> file.
