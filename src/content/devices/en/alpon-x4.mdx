---
title: ALPON X4 Edge Computer
description: 'Connect the Sixfab ALPON X4 Edge Computer gateway to ThingsBoard via Ethernet / WIFI. IoT integration for smart energy.'
platforms:
  - CE
  - Cloud
  - Cloud EU
...
hasBranching: true
vendor: Sixfab
deviceImageFileName: sixfab-alpon-x4.png
...
- <a href="https://connect.sixfab.com" target="_blank" rel="noopener noreferrer">Sixfab Connect Account</a>
- <a href="https://localhost" target="_blank" rel="noopener noreferrer">ThingsBoard account</a>

- **ALPON X4 Device**: Registered and activated on Sixfab Connect with an active internet connection. Refer to the <a href="https://docs.sixfab.com/docs/alpon-x4-getting-started" target="_blank" rel="noopener noreferrer">ALPON X4 Getting Started page</a> setup instructions for details.
...
1. Access your <a href="https://localhost" target="_blank" rel="noopener noreferrer">ThingsBoard instance</a>.
2. Navigate to **Entities > Devices** in the sidebar.

</Steps>

<DocImage src="/src/assets/devices-library/ready-to-go-devices/alpon-x4/1.png" alt="Create Device on ThingsBoard 1" />
...
1. Click on the “+” icon in the top right corner of the table and select "Add new device".
   ...
   <DocImage src="/src/assets/devices-library/ready-to-go-devices/alpon-x4/2.png" alt="Create Device on ThingsBoard 2" />

2. Enter the device name (e.g., `ALPON_X4`). No other changes are required at this time.

   <DocImage src="/src/assets/devices-library/ready-to-go-devices/alpon-x4/3.png" alt="Create Device on ThingsBoard 3" />
...
1. Log in to ThingsBoard. Go to the **Integrations center** -> **Integrations** page.
   ...
   <DocImage src="/src/assets/devices-library/ready-to-go-devices/alpon-x4/5.png" alt="Create an MQTT Integration 1" />

2. Click "plus" icon to add a new integration.
3. Select "**MQTT**" as the integration type.

   <DocImage src="/src/assets/devices-library/ready-to-go-devices/alpon-x4/6.png" alt="Create an MQTT Integration 2" />

4. Select "**TBEL**" as the Downlink data converter.

   <DocImage src="/src/assets/devices-library/ready-to-go-devices/alpon-x4/7.png" alt="Create an MQTT Integration 3" />
...
<DocImage src="/src/assets/devices-library/ready-to-go-devices/alpon-x4/8.png" alt="Create an MQTT Integration 4" />
...
```dockerfile maxLines=10 collapsible
FROM alpine:latest
...
```python maxLines=10 collapsible
...
1. Log in to the Sixfab Connect platform and navigate to the container registry section.
   ...
   <DocImage src="/src/assets/devices-library/ready-to-go-devices/alpon-x4/9.png" alt="Upload the Docker Image 1" />

2. Click on **+ Add Container** and follow the prompts to push the container to the Sixfab Registry.

</Steps>

> Visit the <a href="https://docs.sixfab.com/docs/alpon-x4-manage-and-deploy-applications" target="_blank" rel="noopener noreferrer">Manage & Deploy Applications</a> page for all necessary details on pushing your container image to the Sixfab Registry.

## Deployment Configuration

<Steps>

1. Log in to <a href="https://connect.sixfab.com" target="_blank" rel="noopener noreferrer">**Sixfab Connect**</a>.
...
4. In the **Deploy Container** window:
   ...
   <DocImage src="/src/assets/devices-library/ready-to-go-devices/alpon-x4/10.png" alt="Deployment Configuration 1" />

5. Click the “+ Deploy” button to start the container.

</Steps>

<DocImage src="/src/assets/devices-library/ready-to-go-devices/alpon-x4/11.png" alt="Deployment Configuration 2" />
...
<DocImage src="/src/assets/devices-library/ready-to-go-devices/alpon-x4/12.png" alt="Check Data on ThingsBoard 1" />
...
For further assistance, refer to the <a href="https://thingsboard.io/docs/" class="copy-code">ThingsBoard documentation</a> or contact <a href="https://sixfab.com/contact/" class="copy-code">Sixfab support</a>.
...
1. Access your <a href="https://YOUR_TB_HOST" target="_blank" rel="noopener noreferrer">ThingsBoard instance</a>.
2. Navigate to **Entities > Devices** in the sidebar.
