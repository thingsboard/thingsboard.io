...
- Click on the device that was just associated with the MI-8 and then navigate to the <b>Latest Telemetry</b> tab.
   ...
   <DocImage src="/src/assets/devices-library/ready-to-go-devices/mixed-input-8-channel-analog-cellular-logger/open-device-timeseries.png" alt="Opening time-series data from 8-channel analog logger" />
...
<DocImage src="/src/assets/devices-library/ready-to-go-devices/mixed-input-8-channel-analog-cellular-logger/check-attributes.png" alt="Checking attributes from 8-channel analog cellular logger in ThingsBoard" />
