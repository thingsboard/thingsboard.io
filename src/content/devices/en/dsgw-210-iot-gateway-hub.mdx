...
You can use <a href="https://YOUR_TB_HOST/signup" target="_blank" rel="noopener noreferrer">ThingsBoard Cloud</a> or <a href="/docs/pe/installation/" target="_blank" rel="noopener noreferrer">install</a> your own platform instance.
