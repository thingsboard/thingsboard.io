...
You can use <a href="https://localhost/signup" target="_blank" rel="noopener noreferrer">ThingsBoard Cloud</a> or <a href="/docs/user-guide/install/pe/installation-options/" target="_blank" rel="noopener noreferrer">install</a> your own platform instance.
...
You can use <a href="https://YOUR_TB_HOST/signup" target="_blank" rel="noopener noreferrer">ThingsBoard Cloud</a> or <a href="/docs/user-guide/install/pe/installation-options/" target="_blank" rel="noopener noreferrer">install</a> your own platform instance.
