---
title: DSGW-210 Smart Gateway Hub
description: 'Connect the Dusun DSGW-210 Smart Gateway Hub gateway to ThingsBoard via Bluetooth / Zigbee. IoT integration for smart energy.'
platforms:
  - CE
  - Cloud
  - Cloud EU
...
hasBranching: true
vendor: Dusun
deviceImageFileName: dsgw-210-iot-gateway-hub.png
...
- <a href="https://www.dusuniot.com/product/dsgw-210-rk3328-iot-gateway-hub-controller-bridge-hardware/" target="_blank">DSGW-210 Smart Gateway Hub </a>
- <a href="https://manuals.plus/dusun/dsgw-210-home-assistant-gateway-manual/" target="_blank" rel="noopener noreferrer">DUSUN DSGW-210 Home Assistant Gateway Instruction Manual</a>
...
The configuration steps in ThingsBoard are shown below, we will demonstrate on the localhost server.
You can use <a href="https://localhost/signup" target="_blank" rel="noopener noreferrer">ThingsBoard Cloud</a> or <a href="https://thingsboard.io/docs/user-guide/install/pe/installation-options/" target="_blank" rel="noopener noreferrer">install</a> your own platform instance.

* [Step 1.1] Register and log in <a href="https://localhost/signup" target="_blank" rel="noopener noreferrer">ThingsBoard Cloud</a>;
...
The configuration steps in ThingsBoard are shown below, we will demonstrate on the YOUR_TB_HOST server.
You can use <a href="https://YOUR_TB_HOST/signup" target="_blank" rel="noopener noreferrer">ThingsBoard Cloud</a> or <a href="https://thingsboard.io/docs/user-guide/install/pe/installation-options/" target="_blank" rel="noopener noreferrer">install</a> your own platform instance.

* [Step 1.1] Register and log in <a href="https://YOUR_TB_HOST/signup" target="_blank" rel="noopener noreferrer">ThingsBoard Cloud</a>;
...
* [Step 2.3] Fill in the credentials from the ThingsBoard Cloud:
  * ThingsBoard Server: **YOUR_TB_HOST**
  * Server Port: **1883**
  * Insert the access token obtained in step 1.4
