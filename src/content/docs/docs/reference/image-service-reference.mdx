...
**Type:** <code>(options: <a href="/docs/reference/modules/astro-assets/#imagetransform">ImageTransform</a>, imageConfig: <a href="/docs/reference/configuration-reference/#image-options">AstroConfig['image']</a>) => string | Promise\<string\></code><br />
<Since v="2.1.0" />
</p>
...
**Type:** <code>(url: URL, imageConfig: <a href="/docs/reference/configuration-reference/#image-options">AstroConfig['image']</a>) => \{ src: string, [key: string]: any \} | undefined | Promise\<\{ src: string, [key: string]: any \}\> | Promise\<undefined\></code><br />
<Since v="2.1.0" />
</p>
...
**Type:** <code>(inputBuffer: Uint8Array, options: \{ src: string, [key: string]: any \}, imageConfig: <a href="/docs/reference/configuration-reference/#image-options">AstroConfig['image']</a>) => Promise\<\{ data: Uint8Array; format: <a href="/docs/reference/modules/astro-assets/#imageoutputformat">ImageOutputFormat</a> \}\></code><br />
<Since v="2.1.0" />
</p>
...
**Type:** <code>(options: <a href="/docs/reference/modules/astro-assets/#imagetransform">ImageTransform</a>, imageConfig: <a href="/docs/reference/configuration-reference/#image-options">AstroConfig['image']</a> ) => Record\<string, any\> | Promise\<Record\<string, any\>\></code><br />
<Since v="2.1.0" />
</p>
...
**Type:** <code>(options: <a href="/docs/reference/modules/astro-assets/#imagetransform">ImageTransform</a>, imageConfig: <a href="/docs/reference/configuration-reference/#image-options">AstroConfig['image']</a> ) => UnresolvedSrcSetValue[] | Promise\<UnresolvedSrcSetValue[]\></code><br />
<Since v="3.3.0" />
</p>
...
**Type:** <code>(options: <a href="/docs/reference/modules/astro-assets/#imagetransform">ImageTransform</a>, imageConfig: <a href="/docs/reference/configuration-reference/#image-options">AstroConfig['image']</a> ) => ImageTransform | Promise\<ImageTransform\></code>
<Since v="2.1.4" />
</p>
...
You can expose these types to users by making your image service an [Astro integration](/docs/reference/integrations-reference/) and using the [`injectTypes()`](/docs/reference/integrations-reference/#injecttypes-option) helper.
