...
## What went wrong?
Astro could not find the index URL of your website. An index page is required so that Astro can create a redirect from the main index page to the localized index page of the default locale when using [`i18n.routing.prefixDefaultLocale`](/docs/reference/configuration-reference/#i18nroutingprefixdefaultlocale).

**See Also:**
-  [Internationalization](/docs/guides/internationalization/#routing)
-  [`i18n.routing` Configuration Reference](/docs/reference/configuration-reference/#i18nrouting)
