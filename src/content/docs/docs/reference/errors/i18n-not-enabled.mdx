...
For more information on internationalization support in Astro, see our [Internationalization guide](/docs/guides/internationalization/).

**See Also:**
-  [Internationalization](/docs/guides/internationalization/)
-  [`i18n` Configuration Reference](/docs/reference/configuration-reference/#i18n)
