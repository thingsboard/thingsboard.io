...
## What went wrong?
`getStaticPaths` no longer expose an helper for generating a RSS feed. We recommend migrating to the [@astrojs/rss](/docs/recipes/rss/#setting-up-astrojsrss)integration instead.

**See Also:**
-  [RSS Guide](/docs/recipes/rss/)
