...
For features and usage examples, [see our i18n routing guide](/docs/guides/internationalization/).
...
Use this like [`getAbsoluteLocaleUrl`](/docs/guides/internationalization/#custom-locale-paths) to return a list of absolute paths for all the locales.
...
A function that returns the `path` associated to one or more `codes` when [custom locale paths](/docs/guides/internationalization/#custom-locale-paths) are configured.
...
A function that allows you to use your [`i18n.fallback` configuration](/docs/reference/configuration-reference/#i18nfallback) in your own middleware.
