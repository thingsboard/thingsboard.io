...
The following reference covers all supported configuration options in Astro. To learn more about configuring Astro, read our guide on [Configuring Astro](/docs/guides/configuring-astro/).
...
Deploy to your favorite server, serverless, or edge host with build adapters. Import one of our first-party adapters ([Cloudflare](/docs/guides/integrations-guide/cloudflare/), [Netlify](/docs/guides/integrations-guide/netlify/), [Node.js](/docs/guides/integrations-guide/node/), [Vercel](/docs/guides/integrations-guide/vercel/)) or explore [community adapters](https://astro.build/integrations/2/?search=&categories%5B%5D=adapters) to enable on-demand rendering in your Astro project.

See our [on-demand rendering guide](/docs/guides/on-demand-rendering/) for more on Astro's server rendering options.
...
Read our [Integrations Guide](/docs/guides/integrations-guide/) for help getting started with Astro Integrations.
...
See [the sessions guide](/docs/guides/sessions/) for more information.
...
The Unstorage driver to use for session storage.  The [Node](/docs/guides/integrations-guide/node/#sessions),
[Cloudflare](/docs/guides/integrations-guide/cloudflare/#sessions), and
[Netlify](/docs/guides/integrations-guide/netlify/#sessions) adapters automatically configure a default driver for you,
...
Set `session.ttl` to add a default expiration period for your session values. Passing a `ttl` option to [`session.set()`](/docs/reference/api-reference/#set) will override the global default
...
See the [Prefetch guide](/docs/guides/prefetch/) for more information.
...
See [the images docs](/docs/guides/images/#responsive-image-styles) for more information.
...
See [the `layout` component property](/docs/reference/modules/astro-assets/#layout) for more details.
...
See [the `fit` component property](/docs/reference/modules/astro-assets/#fit) for more details.
...
See [the `position` component property](/docs/reference/modules/astro-assets/#position) for more details.
...
See the [code syntax highlighting guide](/docs/guides/syntax-highlighting/) for usage and examples.
...
- `prism` - use the [Prism](https://prismjs.com/) highlighter and [provide your own Prism stylesheet](/docs/guides/syntax-highlighting/#add-a-prism-stylesheet)
...
See our guide for more information on [internationalization in Astro](/docs/guides/internationalization/)
...
When [`i18n.fallback`](#i18nfallback) is configured to avoid showing a 404 page for missing page routes, this option controls whether to [redirect](/docs/guides/routing/#redirects) to the fallback page, or to [rewrite](/docs/guides/routing/#rewrites) the fallback page's content in place.
...
Both page routes built and URLs returned by the `astro:i18n` helper functions [`getAbsoluteLocaleUrl()`](/docs/reference/modules/astro-i18n/#getabsolutelocaleurl) and [`getAbsoluteLocaleUrlList()`](/docs/reference/modules/astro-i18n/#getabsolutelocaleurllist) will use the options set in `i18n.domains`.

See the [Internationalization Guide](/docs/guides/internationalization/#domains) for more details, including the limitations of this feature.
...
See our guide for more information on [environment variables in Astro](/docs/guides/environment-variables/).
