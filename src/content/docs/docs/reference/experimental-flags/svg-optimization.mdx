...
This experimental feature enables automatic optimization of your [SVG components](/docs/guides/images/#svg-components) using [SVGO](https://svgo.dev/) during build time.
