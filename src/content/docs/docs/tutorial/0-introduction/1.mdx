...
You can use the lessons inside [Unit 1](/docs/tutorial/1-setup/) to make sure you have the development tools and online accounts you'll need to complete the tutorial. It will walk you through creating a new Astro project, storing it on GitHub, and deploying it to Netlify.

If you [create a new, empty Astro project](/docs/install-and-setup/) and are comfortable with your setup, you can safely skip ahead to [Unit 2](/docs/tutorial/2-pages/) where you will start making new pages in your project.
</details>
