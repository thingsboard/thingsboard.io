...
### Resources
- [Astro syntax vs JSX - comparison](/docs/reference/astro-syntax/#differences-between-astro-and-jsx)

- [Astro `<style>` tag](/docs/guides/styling/#styling-in-astro)

- [CSS variables in Astro](/docs/guides/styling/#css-variables)
