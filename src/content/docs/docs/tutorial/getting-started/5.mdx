...
<Steps>
  ...
  4. There are two user activation options:  
...
Use the activation link from the <DocLink product={props.product} path='user-guide/TBD/'>previous step</DocLink> to complete account setup and sign in as a Customer User.
