...
This unit shows you how to set up your development environment and deploy to Netlify. Skip ahead to [Unit 2](/docs/tutorial/2-pages/) if you are already comfortable with your environment and workflow.
...
If all goes well, you should see the code for the file `src/pages/index.astro` opened in split screen with a live preview of the website. Follow the instruction to ["Write your first line of Astro"](/docs/tutorial/1-setup/3/) to make a change to this file.
...
If you'd like to deploy to Netlify, and have a live published version of your site while you work, go ahead in Unit 1 to [Deploy your site to the web](/docs/tutorial/1-setup/5/).

Otherwise, skip to [Unit 2](/docs/tutorial/2-pages/) to start building with Astro!
...
In the file pane, you should see `src/pages/index.astro`. Click to open it, and follow [Write your first line of Astro](/docs/tutorial/1-setup/3/) to make a change to this file.
