...
Read more in the <DocLink product={Products.TRENDZ} path="trendz/settings#signing-key">Signing Key settings</DocLink> reference.
...
For more details see the <DocLink product={Products.TRENDZ} path="trendz/settings#trendz-widget-bundle">Trendz Widget Bundle</DocLink> and <DocLink product={Products.TRENDZ} path="trendz/settings#trendz-js-summary-module">JS Summary Module</DocLink> references.
