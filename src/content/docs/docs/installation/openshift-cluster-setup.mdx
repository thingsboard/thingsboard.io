...
<Aside type="note">
The `--fromVersion` flag is required for upgrades prior to v3.9.1. For example: `./k8s-upgrade-tb.sh --fromVersion=3.8.1`. See <DocLink product={Products.CE} path="TODO">Upgrade Instructions</DocLink> for valid `fromVersion` values.
</Aside>
