...
Docker images and containers can be deployed to many different platforms, like AWS, Azure, and [Google Cloud](/docs/guides/deploy/google-cloud/#cloud-run-ssr-and-static). This recipe won't cover how to deploy your site to a specific platform but will show you how to set up Docker for your project.
...
This Dockerfile will build your site and serve it using Node.js on port `4321` and therefore requires the [Node adapter](/docs/guides/integrations-guide/node/) installed in your Astro project.
...
3. Now that your website is successfully built and packaged in a container, you can deploy it to a cloud provider. See the [Google Cloud](/docs/guides/deploy/google-cloud/#cloud-run-ssr-and-static) deployment guide for one example, and the [Deploy your app](https://docs.docker.com/language/nodejs/deploy/) page in the Docker docs.
</Steps>
