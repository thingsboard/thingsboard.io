...
2. On any Astro page, import the `GET()` method from the endpoint. Call it with the [`Astro` global](/docs/reference/api-reference/) to provide the request context, and use the response on the page:
