...
Astro includes a [development toolbar](/docs/guides/dev-toolbar/) that you can use to inspect your site, check for accessibility and performance issues, and more. This toolbar can be extended with custom apps.
...
Dev toolbar apps can only be added by [Astro Integrations](/docs/guides/integrations-guide/) using [the `astro:config:setup` hook](/docs/reference/integrations-reference/#astroconfigsetup). You will need to create both a toolbar app and the integration that will add it to the toolbar of your existing Astro project.
...
2. In `my-integration.ts`, add the following code to provide both the name of your integration and the [`addDevToolbarApp()` function](/docs/reference/dev-toolbar-app-reference/#toolbar-app-integration-setup) needed to add your dev toolbar app with the `astro:config:setup` hook:
...
<ReadMore> See the [Astro Integration API documentation](/docs/reference/integrations-reference/) for more about building Astro integrations.</ReadMore>
...
<ReadMore>See the [Astro Dev Toolbar API documentation](/docs/reference/dev-toolbar-app-reference/) for more about building dev toolbar apps.</ReadMore>
