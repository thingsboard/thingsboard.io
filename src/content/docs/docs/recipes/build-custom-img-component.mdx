...
In this recipe, you will use the [`getImage()` function](/docs/guides/images/#generating-images-with-getimage) to create your own custom image component that displays different source images based on media queries.
