...
## Prerequisites
- A project with [an adapter for on-demand rendering](/docs/guides/on-demand-rendering/)
- A [UI Framework integration](/docs/guides/framework-components/) installed
