...
In v4.15, Astro added actions which provide several benefits over basic HTML forms including validating your form data and updating your UI based on the form submission. To use this method for building forms instead, see our [actions guide](/docs/guides/actions/) to learn more about these features.
:::

## Prerequisites
- An Astro project with a [server adapter](/docs/guides/on-demand-rendering/#server-adapters) installed.
...
3. Use [validation attributes](https://developer.mozilla.org/en-US/docs/Learn/Forms/Form_validation#using_built-in_form_validation) to provide basic client-side validation that works even if JavaScript is disabled. 
    ...
    To write complex validation logic more easily, you can build your form using a [frontend framework](/docs/guides/framework-components/) and choose a form library like [React Hook Form](https://react-hook-form.com/) or [Felte](https://felte.dev/).
    :::
