...
You can use [Tailwind](https://tailwindcss.com)'s Typography plugin to style rendered Markdown from sources such as Astro's [**content collections**](/docs/guides/content-collections/).
...
An Astro project that:
	...
	- has [Tailwind's Vite plugin](/docs/guides/styling/#tailwind) installed.
	- uses Astro's [content collections](/docs/guides/content-collections/).
