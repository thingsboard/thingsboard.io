...
4. You can now [start the Astro dev server](/docs/develop-and-build/#start-the-astro-dev-server) and see a live preview of your project while you build!
</Steps>
...
You can start a new Astro project and install any [official integrations](/docs/guides/integrations-guide/) or community integrations that support the `astro add` command at the same time by passing the `--add` argument to the `create astro` command.
...
5. Create `astro.config.mjs`
    ...
    If you want to include [UI framework components](/docs/guides/framework-components/) such as React, Svelte, etc. or use other tools such as MDX or Partytown in your project, here is where you will [manually import and configure integrations](/docs/guides/integrations-guide/).

    <ReadMore>Read Astro's [API configuration reference](/docs/reference/configuration-reference/) for more information.</ReadMore>
...
6. Add TypeScript support
    ...
    <ReadMore>Read Astro's [TypeScript setup guide](/docs/guides/typescript/#setup) for more information.</ReadMore>
...
8. You can now [start the Astro dev server](/docs/develop-and-build/#start-the-astro-dev-server) and see a live preview of your project while you build!
