...
- [Pages](/docs/basics/astro-pages/)
- [Layouts](/docs/basics/layouts/)
- [Astro components](/docs/basics/astro-components/)
- [UI framework components (React, etc.)](/docs/guides/framework-components/)
- [Styles (CSS, Sass)](/docs/guides/styling/)
- [Markdown](/docs/guides/markdown-content/)
- [Images to be optimized and processed by Astro](/docs/guides/images/)
...
Pages routes are created for your site by adding [supported file types](/docs/basics/astro-pages/#supported-page-files) to this directory.
...
**Components** are reusable units of code for your HTML pages. These could be [Astro components](/docs/basics/astro-components/), or [UI framework components](/docs/guides/framework-components/) like React or Vue.  It is common to group and organize all of your project components together in this folder.

This is a common convention in Astro projects, but it is not required. Feel free to organize your components however you like!

### `src/layouts`

[Layouts](/docs/basics/layouts/) are Astro components that define the UI structure shared by one or more [pages](/docs/basics/astro-pages/).
...
For help creating a new `package.json` file for your project, check out the [manual setup](/docs/install-and-setup/#manual-setup) instructions.
...
See the [configuration reference](/docs/reference/configuration-reference/) for complete details.
...
See the [TypeScript Guide](/docs/guides/typescript/) for details on setting configurations.
