...
| **Telemetry read queries** | 20K/10s, 60K/min | 100K/10s, 180K/min | 200K/10s, 400K/min | Total telemetry and Rule Engine read queries from WebSocket sessions, REST API calls, or rule nodes |
| **Telemetry write queries** | 10K/10s, 30K/min | 50K/10s, 150K/min | 100K/10s, 300K/min | Total telemetry write queries to the database |
| **Rule Engine write queries** | 20K/10s, 600K/min | 100K/10s, 180K/min | 200K/10s, 400K/min | Total Rule Engine write queries to the database |
