...
| **Telemetry read/write queries** | 20K/10s, 60K/min | 60K/10s, 180K/min | 180K/10s, 540K/min | Total telemetry read/write queries per core and rule nodes from WebSocket sessions, REST API calls, or rule nodes |
