...
5. Zip the template contents — select the files inside the folder, not the folder itself. Open the <a href="https://iot-hub.thingsboard.io/" target="_blank"><strong>IoT Hub Creator Portal</strong></a>, click **+ Add new item**, and complete the upload form with edition, version, categories, and use cases — see **[Editions](#editions)**.
</Steps>
