...
If you are currently using this Astro adapter, you will need to migrate to the new Deno version or to [add another adapter](/docs/guides/on-demand-rendering/) to continue using SSR in your project.
