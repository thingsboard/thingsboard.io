...
- Unlock React, Vue, Svelte, Solid, and other popular UI frameworks with a [renderer](/docs/guides/framework-components/).
- Enable on-demand rendering with an [SSR adapter](/docs/guides/on-demand-rendering/).
...
Check out the [Integration API](/docs/reference/integrations-reference/) reference to learn all of the different ways that you can write an integration.
...
Check out the [Integration API](/docs/reference/integrations-reference/) reference to learn what integrations can do and how to write one yourself.
