...
Use a SolidJS component as you would any [UI framework component](/docs/guides/framework-components/).
...
[astro-client-only]: /docs/reference/directives-reference/#clientonly
