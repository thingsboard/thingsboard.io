...
If this option isn't set, `debug` mode will be on by default in [dev](/docs/reference/cli-reference/#astro-dev) or [preview](/docs/reference/cli-reference/#astro-preview) mode.
