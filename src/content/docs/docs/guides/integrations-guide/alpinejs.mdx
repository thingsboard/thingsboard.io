...
The `@astrojs/alpine` integration adds `Alpine` to [the global window object](/docs/guides/typescript/#window-and-globalthis). For IDE autocompletion, add the following to your `src/env.d.ts`:
