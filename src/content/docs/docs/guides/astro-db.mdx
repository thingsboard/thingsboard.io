...
Install the [`@astrojs/db` integration](/docs/guides/integrations-guide/db/) using the built-in `astro add` command:
...
<ReadMore>See the [table configuration reference](/docs/guides/integrations-guide/db/#table-configuration-reference) for a complete reference of table options.</ReadMore>
...
<ReadMore>See the [table columns reference](/docs/guides/integrations-guide/db/#table-configuration-reference) for more details.</ReadMore>
...
The `--remote` flag uses the connection to the remote DB both locally during the build and on the server. Ensure you set the necessary environment variables in both your local development environment and your deployment platform. Additionally, you may need to [configure web mode](/docs/guides/integrations-guide/db/#mode) for non-Node.js runtimes such as Cloudflare Workers or Deno.
...
You can query your database from any [Astro page](/docs/basics/astro-pages/#astro-pages), [endpoint](/docs/guides/endpoints/), or [action](/docs/guides/actions/) in your project using the provided `db` ORM and query builder.
...
To accept user input, such as handling form requests and inserting data into your remote hosted database, configure your Astro project for [on-demand rendering](/docs/guides/on-demand-rendering/) and [add an adapter](/docs/guides/on-demand-rendering/#add-an-adapter) for your deployment environment.
...
You can also use [Astro actions](/docs/guides/actions/) to insert data into an Astro DB table. The following example inserts a row into a `Comment` table using an action:
...
See the [CLI reference](/docs/guides/integrations-guide/db/#astro-db-cli-reference) for a complete list of commands.

</ReadMore>

## Building Astro DB integrations

[Astro integrations](/docs/reference/integrations-reference/) can extend user projects with additional Astro DB tables and seed data.
