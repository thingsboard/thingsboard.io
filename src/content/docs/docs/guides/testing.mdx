...
You can natively test Astro components using the [container API](/docs/reference/container-reference/). First, setup [`vitest` as explained above](#vitest), then create a `.test.js` file to test your component:
