...
Before you can deploy your Astro site to Cloud Run, you need to create a Dockerfile that will be used to build the container. Find more information about [how to use Docker with Astro](/docs/recipes/docker/#creating-a-dockerfile) in our recipe section.
