...
To tell Zerops how to build and run your site using the official [Astro Node.js adapter](/docs/guides/integrations-guide/node/) in `standalone` mode, add a `zerops.yml` file to your repository:
