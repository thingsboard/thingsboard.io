...
See our separate guide for [adding Firebase backend services](/docs/guides/backend/firebase/) such as databases, authentication, and storage.
...
To enable SSR in your Astro project and deploy on Firebase add the [Node.js adapter](/docs/guides/integrations-guide/node/). 
