...
:::tip
You can [use WordPress as a headless CMS for your Astro project](/docs/guides/cms/wordpress/). Follow our guide to use your existing WordPress content in a new Astro project.
:::
...
- Both WordPress and Astro are ideal for [content-driven websites](/docs/concepts/why-astro/#content-driven) like blogs and support writing your content in Markdown (requires a plugin in WordPress). Although the process for adding new content is different, [writing in Markdown files](/docs/guides/markdown-content/) for your Astro blog should feel familiar if you have used Markdown syntax in your WordPress editor.

- Both WordPress and Astro encourage you to [think about the design of your site in "blocks"](/docs/concepts/islands/) (components). In Astro you will probably [write more of your own code to create these blocks](/docs/basics/astro-components/) rather than rely on pre-built plugins. But thinking about the individual pieces of your site and how they are presented on the page should feel familiar.
...
- A WordPress site is edited using an online dashboard. In Astro, you will use a [code editor](/docs/editor-setup/) and development environment to maintain your site. You can develop locally on your machine, or choose a cloud editor/development environment like IDX, StackBlitz, CodeSandbox or Gitpod.
...
- WordPress stores your content in a database. In Astro, you will have individual files (typically Markdown or MDX) in your [project directory](/docs/basics/project-structure/) for each page's content. Or, you can choose to use a [CMS for your content](/docs/guides/cms/), even your existing WordPress site, and use Astro to fetch and present the data.
...
You can pass a `--template` argument to the `create astro` command to start a new Astro project with one of our official starters. Or, you can [start a new project from any existing Astro repository on GitHub](/docs/install-and-setup/#install-from-the-cli-wizard).
...
You can continue to [use your existing WordPress blog as your CMS for Astro](/docs/guides/cms/wordpress/), which means you will keep using your WordPress dashboard for writing your posts. Your content will be managed at WordPress, but all other aspects of your Astro site will be built in your code editing environment, and you will [deploy your Astro site](/docs/guides/deploy/) separately from your WordPress site. (Be sure to update your domain at your host to keep the same website URL!)

You may wish to take [Astro's Build a Blog Tutorial](/docs/tutorial/0-introduction/) if you are new to working in a code editor and using GitHub to store and deploy your site. It will walk you through all the accounts and setup you need! You will also learn how to [build Astro components yourself](/docs/tutorial/3-components/), and it will show you how to [add blog posts directly in Astro](/docs/tutorial/2-pages/2/) if you choose not to use WordPress to write your content.
