...
You can then use the [`getCollection()` or `getEntry()` query functions](/docs/guides/content-collections/#querying-collections) to select one or many images or videos from your collection.
