...
Yes! Astro provides built-in ways to [store images](/docs/guides/images/#where-to-store-images), including support for referencing remote images.

However, there is no native video support in Astro, and we recommend choosing a service like [Mux](/docs/guides/media/mux/) to handle the demands of optimizing and streaming video content.
