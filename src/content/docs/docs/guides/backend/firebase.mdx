...
See our separate guide for [deploying to Firebase hosting](/docs/guides/deploy/firebase/).
...
- An Astro project with [`output: 'server'` for on-demand rendering](/docs/guides/on-demand-rendering/) enabled.
...
:::tip
Read more about [environment variables](/docs/guides/environment-variables/) and `.env` files in Astro.
:::
...
Firebase authentication in Astro requires the following three [Astro server endpoints](/docs/guides/endpoints/):
