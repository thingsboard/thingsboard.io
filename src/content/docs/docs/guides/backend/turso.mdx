...
:::caution
Do not use the `PUBLIC_` prefix when creating these private [environment variables](/docs/guides/environment-variables/). This will expose these values on the client.
:::
