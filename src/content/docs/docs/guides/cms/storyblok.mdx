...
To generate pages for all of your blog posts, create a `.astro` page that will create dynamic routes. This approach varies depending on whether your routes are prerendered (the default in Astro) or [rendered on demand](/docs/guides/on-demand-rendering/).

#### Static site generation

If you are using Astro's default static site generation, you will use [dynamic routes](/docs/guides/routing/#dynamic-routes) and the `getStaticPaths` function to generate your project pages.
...
If you are [rendering your routes on demand with an adapter](/docs/guides/on-demand-rendering/), you will use dynamic routes to fetch the page data from Storyblok.
