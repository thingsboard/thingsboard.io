...
Some headless CMSes, like Storyblok, provide an Astro [integration](/docs/guides/integrations-guide/) that helps fetch the content specifically for an Astro site. Others provide a JavaScript SDK, a library that you install and use to fetch your remote content.
...
Yes! Astro provides built-in support for [Markdown](/docs/guides/markdown-content/).
