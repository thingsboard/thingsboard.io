...
If you would like to get [TypeScript IntelliSense for these environment variables](/docs/guides/environment-variables/#intellisense-for-typescript), you can create a new `env.d.ts` file in the `src/` directory and configure `ImportMetaEnv` like this:
...
:::note
Read more on [getting environment variables in Astro](/docs/guides/environment-variables/#getting-environment-variables).
:::
...
In this section, you'll use the [Static (SSG) Mode](/docs/guides/routing/#static-ssg-mode) with Astro.
...
If your routes are [rendered on demand](/docs/guides/on-demand-rendering/), you will use dynamic routes to fetch the page data from Kontent.ai.
...
To deploy your website, visit the [deployment guides](/docs/guides/deploy/) and follow the instructions for your preferred hosting provider.
