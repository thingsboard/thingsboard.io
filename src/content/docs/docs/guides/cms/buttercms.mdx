...
The interface mirrors the field types. The WYSIWYG `description` field loads as a string of HTML, and [`set:html`](/docs/reference/directives-reference/#sethtml) lets you render it.
