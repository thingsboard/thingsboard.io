...
If you are using [SSR](/docs/guides/on-demand-rendering/) mode, you will need to fetch a single post based on its `slug`.
...
To deploy your website, visit Astro's [deployment guides](/docs/guides/deploy/) and follow the instructions for your preferred hosting provider.
