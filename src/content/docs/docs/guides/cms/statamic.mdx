...
2. **An Astro project** - If you still need an Astro project, our [Installation guide](/docs/install-and-setup/) will get you up and running quickly.
...
To deploy your Astro site visit our [deployment guides](/docs/guides/deploy/) and follow the instructions for your preferred hosting provider.
