...
1. A Ghost blog 
2. An Astro project integrated with the [Ghost content API](https://www.npmjs.com/package/@tryghost/content-api) - See [integrating with Astro](/docs/guides/cms/ghost/#integrating-with-astro) for more details on how to set up an Astro project with Ghost.
...
The page `src/pages/post/[slug].astro` [dynamically generates a page](/docs/guides/routing/#dynamic-routes) for each post.
...
```
:::note
`<Fragment />` is a built-in Astro component which allows you to avoid an unnecessary wrapper element. This can be especially useful when fetching HTML from a CMS (e.g. Ghost or [WordPress](/docs/guides/cms/wordpress/)).
:::

### Publishing your site
To deploy your site visit our [deployment guide](/docs/guides/deploy/) and follow the instructions for your preferred hosting provider.
