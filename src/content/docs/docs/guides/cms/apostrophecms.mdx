...
1. **An on-demand rendered Astro project** with the [Node.js adapter](/docs/guides/integrations-guide/node/) installed and `output: 'server'` configured - If you don't have an Astro project yet, our [installation guide](/docs/install-and-setup/) will get you up and running in no time.
...
For Astro, visit our [deployment guides](/docs/guides/deploy/) and follow the instructions for your preferred hosting provider.
