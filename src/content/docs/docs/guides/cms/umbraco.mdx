...
<ReadMore>Read more about [data fetching in Astro](/docs/guides/data-fetching/).</ReadMore>

## Building a blog with Umbraco and Astro

### Prerequisites

- **An Astro project** - If you don’t have an Astro project yet, our [Installation guide](/docs/install-and-setup/) will get you up and running in no time.
...
Create the file `[...slug].astro` at the root of the `/pages/` directory. This file will be used to [generate the individual blog pages dynamically](/docs/guides/routing/#dynamic-routes).
...
To deploy your site visit our [deployment guides](/docs/guides/deploy/) and follow the instructions for your preferred hosting provider.
