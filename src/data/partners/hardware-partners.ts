...
export const HARDWARE_PARTNERS: HardwarePartner[] = [
	{
		name: 'Efento',
		slug: 'efento',
		connectivity: ['Bluetooth LE', 'Ethernet', 'LTE', 'NB-IoT'],
		industry: [
		...
		hardwareTypes: ['Sensors', 'Gateways'],
	...
	},
	{
		...
		useCase: ['Fleet Tracking', 'Smart Energy', 'Environment Monitoring', 'Smart Office'],
		hardwareTypes: ['Gateways', 'Sensors', 'Other devices'],
		logo: '/images/partners/teltonika-networks.webp',
		website:
			'https://teltonika-networks.com/?utm_source=iotplatform&utm_medium=referral&utm_content=thingsboard',
		links: {
			generalGuides: [
				{
		...
		description:
			'Rapidly growing technology company, manufacturing professional network connectivity equipment for international markets. It has developed a wide portfolio of products for the most complex areas of Industry 4.0, Smart City, and Green Energy.',
	},
	{
		name: 'Espressif Systems',
		slug: 'espressif',
		connectivity: ['Wi-Fi', 'Bluetooth LE', 'Ethernet'],
		industry: [
			'Smart Cities',
			'Retail',
			'Agriculture',
		...
		hardwareTypes: ['Microcontrollers', 'Single-board computers'],
	...
	},
	{
		...
		hardwareTypes: ['Microcontrollers', 'Gateways', 'Other devices'],
		...
		description:
			'A leading global IoT & M2M solutions provider with 11+ years of deep expertise, trusted in 90+ countries. Our portfolio spans IoT sensors, 5G/4G/LoRa routers, gateways, modems, RTUs, IoT platforms, and OEM&ODM customised solutions. Together, connect for smarts, sustain for tomorrow.',
	},
	{
		name: 'Ezurio',
		slug: 'ezurio',
		connectivity: ['Bluetooth LE', 'LoRaWAN'],
		industry: [
			'Smart Cities',
			'Retail',
			'Agriculture',
		...
		useCase: ['Environment Monitoring', 'Smart Farming'],
		hardwareTypes: ['Sensors', 'Gateways'],
	...
	},
	{
		...
		industry: ['Industrial Manufacturing', 'Smart Buildings', 'Retail', 'Smart Cities'],
		useCase: ['Smart Office', 'Smart Retail', 'Smart Energy'],
		...
		description:
			'Whether you are a developer, technical supplier, or industry player, we provide products and services for your IoT needs.',
		showcases: [
			{
	...
	},
	{
		name: 'Milesight',
		slug: 'milesight',
		connectivity: ['LoRaWAN', 'NB-IoT', 'Wi-Fi', 'Ethernet'],
		industry: [
			'Smart Cities',
			'Retail',
			'Agriculture',
		...
		hardwareTypes: ['Sensors', 'Gateways', 'Trackers'],
		...
		description:
			'Leading innovator in IoT technologies such as sensing, LoRaWAN®, AI, and 5G, has emerged as a frontrunner by unveiling a diverse array of advanced products, like dependable gateways, indoor air quality sensors, occupancy trackers, water leak detectors, and more.',
	},
	{
		name: 'Smartico',
		slug: 'smartico',
		...
		hardwareTypes: ['Sensors', 'Trackers', 'Other devices'],
		...
		description:
			'Research and production complex with its own design bureau, production base, and specialized software development department',
	},
	{
		...
		hardwareTypes: ['Sensors', 'Gateways', 'Trackers', 'Other devices'],
		...
		description:
			'Since 2000, DCT has been developing IoT devices and accessories for Fleet Telematics Applications and Industrial Solutions that are trusted by integrators and service providers around the globe. Their expertise in product design and development together with firmware and software makes the perfect combination for developers to start building amazing applications.',
	},
	{
		name: 'Nettra',
		slug: 'nettra',
		connectivity: ['Wi-Fi', 'Bluetooth LE', 'Ethernet', 'GSM/GPRS'],
		industry: [
			'Smart Cities',
			'Transportation & Logistics',
			'Industrial Manufacturing',
	...
	},
	{
		name: 'Solandtec',
		slug: 'solandtec',
		connectivity: ['Wi-Fi', 'Bluetooth LE', 'Ethernet', 'GSM/GPRS', 'NB-IoT', 'LTE-M', 'Modbus'],
		industry: [
			'Smart Cities',
			'Transportation & Logistics',
			'Industrial Manufacturing',
		...
		useCase: ['Fleet Tracking', 'Smart Farming', 'Smart Irrigation', 'Smart Energy'],
		hardwareTypes: ['Sensors', 'Gateways', 'Other devices'],
		...
		description:
			"With 5+ years' experience, excels in tailored automation, enhancing production and cutting costs. We adeptly apply tech to meet unique needs, reflecting commitment to excellence. Embracing Industry 4.0, we seamlessly integrate IoT, enabling data-driven decisions and proactive steps. We pride in enhancing efficiency and connectivity for evolving businesses.",
	},
	{
		name: 'Actility',
		slug: 'actility',
		connectivity: ['LoRaWAN', 'NB-IoT', 'LTE-M', 'GSM/GPRS', 'Modbus', 'BACnet'],
		industry: [
			'Smart Cities',
			'Transportation & Logistics',
			'Industrial Manufacturing',
		...
		hardwareTypes: ['Trackers', 'Gateways'],
		...
		description:
			'Strong background in large-scale project delivery and a heritage in carrier-grade systems, with leading customer deployments worldwide, making it the global leader in IoT connectivity solutions deployment.',
	},
	{
		name: 'SODAQ',
		slug: 'sodaq',
		connectivity: ['LoRaWAN', 'NB-IoT', 'LTE-M', 'GSM/GPRS'],
		industry: [
			'Smart Cities',
			'Agriculture',
			'Transportation & Logistics',
		...
		hardwareTypes: ['Single-board computers', 'Sensors', 'Trackers', 'Other devices'],
	...
	},
	{
		...
		hardwareTypes: ['Single-board computers', 'Sensors'],
		...
		description:
			'Fully customisable solution for developers who want to focus on their own applications and core competencies rather than the underlying hardware platform or production logistics when creating products for the IoT.',
	},
	{
		name: 'Sensy32',
		slug: 'sensy32',
		...
		hardwareTypes: ['Microcontrollers', 'Sensors', 'Gateways', 'Other devices'],
		...
		description:
			"All-in-One Sensor IoT Board with LCD designed for sensor enthusiasts, developers, and IoT creators. Powered by ESP32-S3 and packed with a wide array of sensors, it enables seamless monitoring, analysis, and visualization of real-world data. Backed by a robust ESP32-S3 Wifi and Bluetooth module, Sensy32 is not just a board; it's a gateway to endless possibilities.",
	},
	{
		name: 'DECODE',
		slug: 'decode',
		connectivity: ['GSM/GPRS', 'RS232', 'RS485', 'M-Bus'],
		industry: [
			'Smart Cities',
			'Retail',
			'Transportation & Logistics',
		...
		hardwareTypes: ['Single-board computers', 'Sensors', 'Gateways', 'Trackers', 'Other devices'],
		...
		description:
			'Serbian company with extensive experience in design, engineering and production of devices for industrial communication and telemetry.',
	},
	{
		name: 'TEKTELIC Communications Inc.',
		slug: 'tektelic',
		connectivity: ['LoRaWAN', 'NB-IoT', 'LTE-M', 'GSM/GPRS', 'Modbus'],
		industry: [
			'Smart Cities',
			'Transportation & Logistics',
			'Industrial Manufacturing',
		...
		links: {},
		description:
			'Leading supplier of LoRaWAN IoT equipment including best-in-class gateways and end devices.',
	},
	{
		name: 'AKKR8',
		slug: 'akkr8',
		...
		links: {},
		description:
			'Developed and manufactured in Sweden, flexible sensor-to-platform solution designed for scalable, low-maintenance IoT deployments. It is well-suited for smart buildings, facility management, utilities, and industrial environments requiring robust connectivity and modular sensor integration.<br> Supports multiple power options—battery, solar, or mains—making it adaptable to both remote and on-site installations. It connects over LTE-M for reliable, low-power communication in constrained network conditions.<br> As a BLE gateway, Integrates seamlessly with sensors from industry leaders such as Aguardio, ELA Innovation, and Smart Sensor Devices, enabling applications like leak detection, environmental monitoring, occupancy sensing, and air quality measurement. The device is sold pre-configured for the ThingsBoard platform, providing out-of-the-box compatibility and simplified device management at scale.',
	},
	{
		name: 'ROLTEK',
		slug: 'roltek',
		connectivity: ['Wi-Fi', 'Bluetooth LE', 'GSM/GPRS', 'LoRaWAN', 'NB-IoT', 'LTE-M', 'Modbus'],
		industry: ['Industrial Manufacturing', 'Smart Buildings', 'Energy Management', 'Security'],
		useCase: ['Smart Office', 'Smart Energy'],
		hardwareTypes: ['Sensors', 'Gateways', 'Trackers', 'Other devices'],
	...
	},
	{
		...
		description:
			'Designs and produces electronic solutions for automation, industrial process control, photovoltaics, energy management and home automation.',
	},
	{
		name: 'Shenzhen Beilai Technology Co., Ltd.',
		slug: 'beilai',
		connectivity: ['Bluetooth LE', 'LoRaWAN', 'Wi-Fi', '4G', 'Ethernet'],
		industry: [
			'Smart Cities',
			'Retail',
			'Agriculture',
		...
		hardwareTypes: ['Single-board computers', 'Gateways', 'Other devices'],
	...
	},
	{
		...
		links: {
			gatewayGuides: [
				{
					label:
						'Connect the MClimate 16A Switch & Power Meter compact 16A relay and electricity meter to ThingsBoard',
	...
	},
	{
		...
		description:
			'Rugged, programmable telemetry devices that connect to any industrial sensor or system.',
	},
	{
		name: 'Dusun',
		slug: 'dusun',
		connectivity: ['Wi-Fi', 'Bluetooth LE', 'LoRaWAN', 'NB-IoT', 'LTE-M', 'Modbus'],
		industry: [
			'Smart Cities',
			'Agriculture',
			'Transportation & Logistics',
	...
	},
	{
		name: 'monoZ',
		slug: 'monoz',
		connectivity: ['GSM/GPRS', 'Wi-Fi', 'Bluetooth LE', 'LoRaWAN', 'NB-IoT', 'LTE-M', 'Modbus'],
		industry: [
			'Smart Cities',
			'Retail',
			'Transportation & Logistics',
		...
		hardwareTypes: ['Single-board computers', 'Other devices'],
		...
		description:
			'Aim to assist System Integrators and Enterprises in connecting their assets (things) to the internet at the lowest possible cost and time. Belong to the first few E2C IoT enablers in the world to offer all the components required for businesses to make their ideas a reality.',
	},
	{
		name: 'EXXN',
		slug: 'exxn',
		...
		useCase: ['Environment Monitoring', 'Air Quality Monitoring'],
		hardwareTypes: ['Gateways', 'Sensors', 'Other devices'],
		...
		description:
			'We specialize in integrating technology into your business to enhance efficiency and productivity. Our multipurpose gateways, equipped with an ARM processor, are customizable to meet the specific needs of each customer and use case.',
	},
	{
		name: 'Fusion DAQ',
		slug: 'fusiondaq',
		...
		description:
			'Develops and maintains a core product line of data acquisition components and accessories. This includes electronic design, electromechanical integration, PCB and component assembly, as well as software, both embedded and PC.',
	},
	{
		name: 'Yobiiq B.V.',
		slug: 'yobiiq',
		connectivity: ['LoRaWAN', 'NB-IoT', 'LTE-M', 'Modbus', 'BACnet'],
		industry: [
			'Smart Cities',
			'Transportation & Logistics',
			'Industrial Manufacturing',
		...
		useCase: ['Smart Office', 'Air Quality Monitoring', 'Smart Energy'],
		hardwareTypes: ['Sensors', 'Gateways'],
		...
		description:
			'The best way to predict the future is by creating it. As an IoT Solutions Company, we develop smart solutions daily, tailored to your business and objectives. We pride ourselves on being a bit different, boosted by a healty dose of honest, straightforward communication without exaggeration. Manufacturing and creating devices that work, period is what we do.',
	},
	{
		name: 'YuDash',
		slug: 'yudash',
		connectivity: ['4G/LTE', 'LAN', 'Wi-Fi'],
		industry: [
			'Smart Cities',
			'Industrial Manufacturing',
			'Smart Buildings',
		...
		hardwareTypes: ['Gateways', 'Other devices'],
		...
		description:
			'Industrial IoT gateway manufacturer, offering flexible, user-friendly, and cost-effective products. Cloud connectivity through 4G/LTE, Ethernet and WiFi is available. Industrial protocols like Modbus-RS485, Modbus-TCP/IP, Analog and I2C are supported to IoT enable Industrial PLCs, Instruments and Sensors. Our products are used in Environment, Weather, Energy, Remote Asset Management and Industry 4.0 applications.',
	},
	{
		name: 'MOKO SMART',
		slug: 'mokosmart',
		...
		hardwareTypes: ['Microcontrollers', 'Sensors', 'Gateways', 'Trackers', 'Other devices'],
	...
	},
	{
		...
		hardwareTypes: ['Single-board computers', 'Sensors', 'Gateways'],
		...
		description:
			'IoT Hardware Design and Development Company specializing in Wireless IoT sensors. It offers a wide range of plug-and-play devices for monitoring temperature, humidity, pressure, energy, acceleration, gas, and industrial I/O. Our devices allow control over pumps, valves, motors, relays, and more. All products are manufactured in the USA. Since 1995, NCD.io has been providing custom IoT hardware and firmware solutions.',
	},
	{
		name: 'Temco Controls',
		slug: 'temcocontrols',
		...
		industry: ['Smart Cities', 'Industrial Manufacturing', 'Energy Management', 'Security'],
		useCase: [
			'Smart Office',
			'Smart Energy',
			'Air Quality Monitoring',
	...
	},
	{
		...
		description:
			'Specialist IoT solution provider focusing on Lorawan sensors for indoor air quality monitoring, our vision is to transform how we manage and maintain healthy indoor environments.',
	},
	{
	...
	},
	{
		...
		useCase: ['Fleet Tracking', 'Smart Farming', 'Health Care', 'Smart Office', 'Smart Retail'],
		hardwareTypes: ['Sensors', 'Gateways', 'Trackers'],
	...
	},
	{
		...
		hardwareTypes: ['Gateways', 'Single-board computers'],
	...
	},
	{
		...
		slug: 'dragino',
		connectivity: ['LoRaWAN', 'NB-IoT', 'LTE-M', 'CAT-1'],
		industry: [
			'Smart Cities',
			'Retail',
			'Agriculture',
	...
	},
	{
		...
		hardwareTypes: ['Single-board computers', 'Gateways', 'Trackers'],
	...
	},
	{
		...
		useCase: ['Fleet Tracking', 'Smart Farming', 'Waste Management'],
		hardwareTypes: ['Trackers', 'Sensors'],
	...
	},
	{
		...
		description:
			'Professional open-source hardware provider based in Shenzhen, China, offering end-to-end support from concept design, prototyping, small-batch manufacturing, to full-scale production. We are especially experienced in LoRa and LoRaWAN technologies and have helped many clients realize custom IoT solutions across agriculture, smart cities, and industrial monitoring. To better serve these industries, we have established the AgroSense brand – a comprehensive line of LoRaWAN sensors, designed for reliability, adaptability, and ease of integration.',
	},
	{
		name: 'Chengdu IOTRouter Tech. Co., Ltd.',
		slug: 'iotrouter',
		connectivity: ['5G/4G LTE', 'LAN', 'Wi-Fi', 'RS485'],
		industry: [
			'Smart Cities',
			'Retail',
			'Agriculture',
