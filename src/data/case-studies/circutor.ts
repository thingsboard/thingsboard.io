...
export const circutorData: CaseStudyData = {
	...
	pageSlug: 'circutor',
	breadcrumb: 'Circutor — Smart Energy',
	categories: ['Smart energy'],

	hero: {
		category: 'SMART ENERGY',
		heading: 'Circutor scales global energy management with ThingsBoard IoT platform',
		paragraphs: [
			'Circutor is a global leader with over 40 years of experience in the design and manufacture of units dedicated to improving energy efficiency. Their portfolio spans a broad range of solutions, including electrical energy management, power quality measurement and control, industrial electrical protection, reactive energy compensation, and harmonic filtering. CIRCUTOR owns a wide variety of connected energy control and metering devices, tailored to meet the growing demands of industrial and energy sectors worldwide.',
		],
	...
	quote: {
		text: 'CIRCUTOR owns a wide portfolio of connected energy control and metering devices. Despite the diversity of proprietary and off-the-shelf data protocols, Thingsboard has made it easy to accommodate most of our products in a common data plat...',
		author: 'Circutor, Cloud & App Development Manager',
	},

	problem: {
		challenges: [
			'Circutor had a wide range of connected energy devices using different proprietary and standard protocols.',
			'Integrating all devices into one centralized platform was complex and challenging.',
			'They needed a flexible solution that could easily adapt to various communication standards.',
		],
		results: [
			'ThingsBoard enabled seamless integration of most devices into a common platform.',
			'Circutor streamlined device management and improved operational efficiency.',
			"They praised ThingsBoard's flexibility, reliability, and responsive technical support.",
		],
	},
	...
	power: {
		...
		blocks: [
			{
				title: 'Flexibility that powers efficiency',
				text: "ThingsBoard provided Circutor with the flexibility and adaptability they required. Despite the variety of communication protocols used across their devices, ThingsBoard's architecture allowed seamless integration into a unified, scalable platform. Circutor particularly appreciated the ThingsBoard team's dynamism and professionalism, highlighting the team's openness to technical suggestions and their commitment to implementing requested functionalities. The platform's reliability, flexibility, and outstanding technical service empowered Circutor to elevate their energy efficiency solutions even further.",
				image: 'https://img.thingsboard.io/case-studies/circutor-1.webp',
				imageAlt: 'Flexibility that powers efficiency',
			},
		],
	},
	...
	contact: {
		companyLogo: 'https://img.thingsboard.io/case-studies/circutor.svg',
		companyLogoAlt: 'Circutor logo',
