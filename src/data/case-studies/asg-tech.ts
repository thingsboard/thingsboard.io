...
export const asgTechData: CaseStudyData = {
	...
	problem: {
		...
		results: [
			"ASG Tech significantly accelerated their project timelines through collaboration with ThingsBoard's development unit.",
			'A carefully estimated project scope improved planning and collaboration processes.',
			"The custom widgets developed not only met but exceeded ASG Tech's expectations, demonstrating impressive quality, seamless integration, and enhanced functionality.",
			'This partnership enabled ASG Tech to enhance their solutions faster and deliver superior customer experiences.',
		],
	},

	power: {
		companyName: 'ASG Tech',
		blocks: [
			{
				title: 'Custom development that delivers real value',
				text: "ThingsBoard's development unit empowered ASG Tech by offering deep technical expertise, transparent communication, and a highly professional approach to custom development. By attentively listening to ASG Tech's detailed requirements and translating them into thoughtfully crafted custom widgets, the ThingsBoard team ensured that the final deliverables aligned perfectly with ASG Tech's goals. The smooth development process, regular updates, and commitment to quality provided ASG Tech with a reliable, long-term technology partner.",
				image: 'https://img.thingsboard.io/case-studies/custom-development.webp',
				imageAlt: 'Custom development that delivers real value',
			},
		],
	},
	...
	help: {
		industryName: 'the IoT solutions field improve operations',
		blocks: [
			{
				...
				listItems: [
					...
					"Achieve greater scalability with ThingsBoard's microservices architecture, supporting millions of devices and data points.",
					'Ensure security and compliance through robust authentication, authorization, and data encryption mechanisms.',
	...
	contact: {
		companyLogo: 'https://img.thingsboard.io/case-studies/asg-tech.svg',
		companyLogoAlt: 'ASG Tech logo',
