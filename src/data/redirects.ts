...
export const SINGLE_REDIRECTS: SingleRedirect[] = [
	...
	{ oldPath: 'samples/digicom/energy-meter-monitoring-with-thingsboard-iot-plaƞorm', target: '/device-library/digicom-energy-meter-monitoring/' },
	{ oldPath: 'pe/samples/digicom/energy-meter-monitoring-with-thingsboard-iot-plaƞorm', target: '/device-library/digicom-energy-meter-monitoring/' },
	{ oldPath: 'paas/samples/digicom/energy-meter-monitoring-with-thingsboard-iot-plaƞorm', target: '/device-library/digicom-energy-meter-monitoring/' },
	{ oldPath: 'paas/eu/samples/digicom/energy-meter-monitoring-with-thingsboard-iot-plaƞorm', target: '/device-library/digicom-energy-meter-monitoring/' },
