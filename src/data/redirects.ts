...
export const SINGLE_REDIRECTS: SingleRedirect[] = [
	...
	{ oldPath: 'user-guide/install/pe/edge/installation-options', target: '/docs/edge/pe/installation/' },
	...
	{ oldPath: 'pe/user-guide/rule-engine-2-0/analytics-nodes', target: '/docs/reference/rule-engine/nodes/analytics/' },
	{ oldPath: 'paas/user-guide/rule-engine-2-0/analytics-nodes', target: '/docs/reference/rule-engine/nodes/analytics/' },
	{ oldPath: 'paas/eu/user-guide/rule-engine-2-0/analytics-nodes', target: '/docs/reference/rule-engine/nodes/analytics/' },
	{ oldPath: 'user-guide/rule-engine-2-0/nodes/analytics/alarms-count-deprecated', target: '/docs/reference/rule-engine/nodes/analytics/alarms-count/' },
	{ oldPath: 'pe/user-guide/rule-engine-2-0/nodes/analytics/alarms-count-deprecated', target: '/docs/pe/reference/rule-engine/nodes/analytics/alarms-count/' },
	{ oldPath: 'paas/user-guide/rule-engine-2-0/nodes/analytics/alarms-count-deprecated', target: '/docs/paas/reference/rule-engine/nodes/analytics/alarms-count/' },
	{ oldPath: 'paas/eu/user-guide/rule-engine-2-0/nodes/analytics/alarms-count-deprecated', target: '/docs/paas/eu/reference/rule-engine/nodes/analytics/alarms-count/' },
	...
	{ oldPath: 'user-guide/rule-engine-2-0/tutorials/telemetry-delta-validation', target: '/docs/pe/recipes/telemetry-delta-calculation/' },
	...
	{ oldPath: 'user-guide/ui/advanced-data-key-configuration', target: '/docs/pe/user-guide/advanced-data-key-configuration/' },
	...
	{ oldPath: 'user-guide/ui/widgets/trip-animation-widget', target: '/docs/pe/reference/widgets/map-widgets/' },
