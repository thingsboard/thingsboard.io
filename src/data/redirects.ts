...
export const SINGLE_REDIRECTS: SingleRedirect[] = [
	...
	{ oldPath: 'releases/releases-table', target: '/docs/releases/release-table/' },
	{ oldPath: 'pe/releases/releases-table', target: '/docs/pe/releases/release-table/' },
	{ oldPath: 'releases/roadmap', target: '/docs/releases/roadmap/' },
	{ oldPath: 'pe/releases/roadmap', target: '/docs/pe/releases/roadmap/' },
