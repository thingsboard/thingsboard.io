...
export const SINGLE_REDIRECTS: SingleRedirect[] = [
  ...
  { oldPath: 'user-guide/integrations/remote-integrations', target: '/docs/user-guide/integrations/' },
	...
	// mobile/pe "before v1.7" pages: CATCH_ALL generates hyphen slugs from filenames,
	// but custom slug frontmatter puts the page at the dot URL — bridge the gap
	{ oldPath: 'mobile/pe/app-icon-splash-screen-before-v1-7', target: '/docs/mobile/pe/app-icon-splash-screen-before-v1.7/' },
	{ oldPath: 'mobile/pe/qr-code-settings-before-v1-7', target: '/docs/mobile/pe/qr-code-settings-before-v1.7/' },
	{ oldPath: 'mobile/pe/release-before-v1-7', target: '/docs/mobile/pe/release-before-v1.7/' },

	// /index/ variants generated by CATCH_ALL prefix rules — target the canonical section root
	{ oldPath: 'edge/pe/index', target: '/docs/edge/pe/' },
	{ oldPath: 'mobile/pe/index', target: '/docs/mobile/pe/' },
	{ oldPath: 'mqtt-broker/pe/index', target: '/docs/mqtt-broker/pe/' },
	{ oldPath: 'getting-started/index', target: '/docs/getting-started/' },
	{ oldPath: 'pe/getting-started/index', target: '/docs/pe/getting-started/' },
	{ oldPath: 'paas/getting-started/index', target: '/docs/paas/getting-started/' },
	{ oldPath: 'paas/eu/getting-started/index', target: '/docs/paas/eu/getting-started/' },
];
