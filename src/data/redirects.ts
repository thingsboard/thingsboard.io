...
{ oldPath: 'user-guide/integrations/remote-integrations', target: '/docs/user-guide/integrations/' },
	...
	{ oldPath: 'paas/user-guide/contribution/ui/basic-widget-api', target: '/docs/pe/reference/widgets/widget-api/' },
	{ oldPath: 'paas/eu/user-guide/contribution/ui/basic-widget-api', target: '/docs/pe/reference/widgets/widget-api/' },
