...
export const tbCeFaq: FaqCategory[] = [
	{
		...
		items: [
			...
			},
			{
				...
				question: 'Is it possible to migrate from the Community Edition to the ThingsBoard Cloud?',
				answer:
		...
		items: [
			{
				...
				answer:
					'<p>The Community Edition includes device and asset management, data visualization, rule engine automation, and API integrations. You can find all features and descriptions <a target="_blank" href="/docs/">here</a>.</p>',
			},
			{
			...
			},
			{
				...
				answer:
					'<p>Not natively, but you can use it with <a target="_blank" href="/products/trendz/">Trendz Analytics</a> or integrate external AI/ML services via APIs.</p>',
			},
		],
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer:
					'<p>Depending on the type of support you are looking for, the ThingsBoard team may be able to offer certain types of additional support packages. To discuss your unique case and requirements, please <a target="_blank" href="/contact-us/">contact us</a>.</p>',
			},
			{
				id: 'ce-help-issue',
				question: 'Where can I get help if I run into issues?',
				answer:
					'<p><a target="_blank" href="https://github.com/thingsboard/">GitHub</a> (report issues, contribute)</p><p><a target="_blank" href="https://stackoverflow.com/questions/tagged/thingsboard">Stack Overflow</a> (for developer-related questions)</p><p><a target="_blank" href="/docs/">Documentation & Tutorials</a></p>',
			},
			{
			...
			},
			{
				...
				answer:
					'<p>The ThingsBoard team can propose application configuration services. To discuss your unique case and requirements, please <a target="_blank" href="/contact-us/">contact us</a>.</p>',
			},
			{
				id: 'ce-soft-updates',
			...
			},
			{
				...
				question: 'Can I get ThingsBoard developers to help with my Community Edition deployment?',
				answer:
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer:
					'<ul><li>White labeling for branding</li><li>RBAC for application business security strategy</li><li>Advanced integrations capabilities</li><li>Grouping functionality</li><li>Reporting, etc.</li></ul><p>ThingsBoard Professional Edition is designed for production and enterprise IoT solutions, offering comprehensive features to meet all your potential needs with the flexibility to deliver tailored solutions without any blockers.</p>',
			},
			{
				id: 'migrate-pe-to-enterprise',
				question: 'How do I migrate from Professional Edition to Enterprise?',
				answer:
					'<p>Migration depends on factors such as whether you are migrating to a self-managed system or ThingsBoard Cloud, the version, source code changes, and more. Please <a target="_blank" href="/contact-us/">contact us</a> for personalized suggestions and a clear strategy on how to perform the migration.</p>',
			},
			{
				id: 'enterprise-trial',
				question: 'Can I get a trial of the Enterprise Edition before upgrading?',
				answer:
					'<p>Yes, we offer a one-month trial on ThingsBoard Cloud for users considering an upgrade. If you would like to try the system in self-managed mode, please <a target="_blank" href="/contact-us/">contact us</a>.</p>',
			},
		],
	},
	{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				question: 'Can I use ThingsBoard Edge Community Edition for commercial projects?',
				answer:
			...
			},
			{
				...
				question: 'What are the system requirements for deploying the Community Edition?',
				answer:
			...
			},
			{
				...
				answer:
					'<ul><li>Device management and telemetry</li><li>Rule engine for data processing</li><li>Dashboard creation</li><li>Support for MQTT, CoAP, and HTTP protocols</li><li>Open-source extensibility through plugins</li></ul>',
			},
			{
				id: 'edge-community-support-options',
				question: 'What support options are available for the Community Edition?',
				answer:
					'<p>Support for the Community Edition is primarily community-driven, including:</p><ul><li>Community Forums: Engage with other users and developers.</li><li>GitHub Issues: Report bugs or request features.</li><li>Documentation: Comprehensive guides and API references available on the ThingsBoard Documentation.</li></ul>',
			},
			{
