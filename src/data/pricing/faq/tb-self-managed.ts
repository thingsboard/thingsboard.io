...
export const tbSelfManagedFaq: FaqCategory[] = [
	{
		...
		items: [
			...
			},
			{
				...
				answer:
					'<p>If you would like to explore the Perpetual option, please <a target="_blank" href="/contact-us/">contact our sales team</a></p>',
			},
			{
			...
			},
			{
				...
				answer:
					'<p>Please, <a target="_blank" href="/contact-us/">contact us</a> in case migration assistance is needed.</p>',
			},
			{
			...
			},
			{
				...
				question:
					'Can I migrate from one server or Virtual machine to another using the same license?',
				answer:
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer:
					'<p>Contact our <a target="_blank" href="/contact-us/">sales team</a> for bulk pricing options.</p>',
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer:
					'<p>By default, the platform requires active Internet access or at least access to license portal from your host machine. If Offline access is a must, please <a target="_blank" href="/contact-us/">contact us</a> to discuss options.</p>',
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer:
					'<p>ThingsBoard Maker includes Trendz for free. If you need a free trial for other subscriptions, <a target="_blank" href="/contact-us/">Contact us</a> for details.</p>',
			},
			{
