...
export const tbCloudFaq: FaqCategory[] = [
	{
		...
		items: [
			...
			},
			{
				...
				question:
					'Can I create a custom plan with the ability to choose limits for devices, assets, users, etc.?',
				answer:
			...
			},
			{
				...
				answer:
					'<p>We recommend using the <a target="_blank" href="/docs/user-guide/version-control/">Version control</a> feature to migrate your configurations. Telemetry data export can be achieved via REST API. Please, <a target="_blank" href="/contact-us/">contact us</a> in case migration assistence needed.</p>',
			},
			{
				id: 'tb-cloud-us-to-eu',
				question: 'I need to move from US cloud to EU. How to achieve that?',
				answer:
					'<p>Technically, you have to follow the same flow as for How to migrate from the Cloud to a self-service platform copy. Please, <a target="_blank" href="/contact-us/">contact us</a> in case migration assistence needed.</p>',
			},
			{
		...
		items: [
			{
				...
				answer:
					'<p>Billing is handled via Stripe and is charged monthly based on your selected plan. You can also pay annually with card or wire transfer. Please <a target="_blank" href="/contact-us/">contact us</a> to receive a custom invoice.</p>',
			},
			{
				id: 'tb-cloud-payment-methods',
				question: 'What payment methods do you accept?',
				answer:
					'<p>We accept credit and debit cards through Stripe. You can also pay annually with card or wire transfer. Please <a target="_blank" href="/contact-us/">contact us</a> to receive a custom invoice.</p>',
			},
			{
				id: 'tb-cloud-use-wire-instead-of-card',
				question: 'I cannot pay by card, may we use wire instead?',
				answer:
					'<p>Sure. In this case, you must reach out to our sales team via <a target="_blank" href="/contact-us/">contact us</a>. If you have ongoing communication with the account manager or success manager on our end, please refer your request to that person.</p>',
			},
			{
				id: 'tb-cloud-pay-monthly-or-annually',
				question: 'Can I pay monthly or annually?',
				answer:
					'<p>We currently offer only a monthly subscription with automatic payments via Stripe. For annual payments, please <a target="_blank" href="/contact-us/">contact</a> our team to arrange a wire transfer invoice.</p>',
			},
			{
				id: 'tb-cloud-volueme-discounts',
				question: 'Do you offer volume discounts for large deployments?',
				answer:
					'<p>We offer Private Cloud plans for large-scale deployments with 10% discounts for annual payments; <a target="_blank" href="/contact-us/">contact us</a> for details.</p>',
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				question:
					'What support options are available for migrating to a self-managed system instead of switching to the Enterprise plan?',
				answer:
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer:
					'<p>Yes, we do provide 24/7 support. If this is what you\'re looking for, please <a target="_blank" href="/contact-us/">contact us</a> for a more detailed discussion about your specific needs.</p>',
			},
			{
				id: 'tb-cloud-support-billing',
				question: 'How can I contact ThingsBoard support for billing-related issues?',
				answer:
					'<p>You can use the <a target="_blank" href="/contact-us/">contact us</a> form and select the "Other" topic. Our account managers will assist you with any billing-related issues.</p>',
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer:
					'<p>Edge edition must match your ThingsBoard Server edition:</p><ul><li><b>Edge PE</b> connects to ThingsBoard PE Server.</li><li><b>Edge CE</b> connects to ThingsBoard CE Server.</li></ul><p>Note: Community Editions are free and open-source.</p>',
			},
			{
			...
			},
			{
				...
				answer:
					'<p>You can start with the <b>Free</b> plan (limited to 5 devices) with the Edge Computing add-on permanently enabled. This lets you explore Edge PE features at no cost.</p><p>For larger deployments, you can upgrade to paid plans with higher device limits and additional features.</p>',
			},
			{
			...
			},
			{
				...
				answer:
					'<p>The number of included Edge instances depends on your subscription plan. Additional instances can be purchased separately. Check your plan details or <a target="_blank" href="/contact-us/">contact us</a> for specifics.</p>',
			},
			{
			...
			},
			{
				...
				answer:
					'<p>Yes. Software updates are included with active Edge licenses:</p><ul><li><b>Subscription licenses:</b> Receive updates throughout the subscription period.</li><li><b>Perpetual licenses:</b> Include 1 year of updates, renewable annually.</li></ul>',
			},
			{
				id: 'edge-addon-cloud-expiration',
				question: 'What happens when my Edge subscription expires?',
				answer:
					"<p>Your Edge instance will stop functioning when the license expires. You'll need to renew your Edge license to continue using the instance.</p><p>For <b>perpetual licenses</b>, only updates and support expire — the Edge instance continues running.</p>",
			},
			{
				id: 'edge-addon-cloud-upgrade-ce-pe',
				question: 'Can I upgrade from Edge CE to Edge PE?',
				answer:
					'<p>Yes, but you\'ll need to upgrade your entire system: upgrade your ThingsBoard Server from CE to PE, purchase the Edge Computing add-on, and reinstall Edge using PE packages. Please <a target="_blank" href="/contact-us/">contact us</a> for migration assistance.</p>',
			},
			{
