...
export const tbmqCeFaq: FaqCategory[] = [
	{
		...
		items: [
			...
			},
			{
				...
				answer: '<p>Yes, clustering is fully supported in the Community Edition. You can find more details about deployment scenarios <a target="_blank" href="/docs/mqtt-broker/install/installation-options/" rel="noopener noreferrer">in the deployment options guide</a>.</p>',
			},
			{
		...
		items: [
			{
				...
				answer: '<p>Installation guides are available in the <a target="_blank" href="/docs/mqtt-broker/install/installation-options/" rel="noopener noreferrer">documentation</a>. The Community Edition can be installed in monolith or cluster mode, and supports deployment on Docker and Kubernetes.</p>',
			},
			{
