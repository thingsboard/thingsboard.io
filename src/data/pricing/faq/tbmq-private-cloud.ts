	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				question:
					'What happens if my plan is upgraded to higher tier during an annual subscription?',
				answer:
		...
		items: [
			{
				...
				answer:
					'<p>Trial access is available by deploying TBMQ Community Edition, which lets you explore the core MQTT features in your own environment. <br><br></p><p>For TBMQ Private Cloud, trials are not applicable due to the use of dedicated infrastructure and custom deployment.</p>',
			},
			{
