	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: `<p>All perpetual license packages provide dedicated support with predefined response time and access to the ThingsBoard Support Portal. Our expert support team is available to assist you with system deployment by following our recommended <a target="_blank" href="/docs/mqtt-broker/install/installation-options/" rel="noopener noreferrer">installation methods</a> and architecture, ensuring a smooth and efficient setup. For custom installation scripts or alternative deployment scenarios, additional support options are available and you can <a target="_blank" href="/contact-us/" rel="noopener noreferrer">contact us</a> to discuss your needs.</p>`,
			},
		],
	},
];
