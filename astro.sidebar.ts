...
const guideItems = (prefix: string, { isPE = false } = {}) => [
	...
	},
	{
		...
		items: [
			...
			`${prefix}/integrations/loriot`,
			`${prefix}/integrations/kpn-things`,
			`${prefix}/integrations/aws-iot`,
			`${prefix}/integrations/aws-kinesis`,
			`${prefix}/integrations/azure-event-hub`,
			`${prefix}/integrations/azure-service-bus`,
				`${prefix}/integrations/azure-iot-hub`,
				`${prefix}/integrations/tcp`,
				`${prefix}/integrations/udp`,
				`${prefix}/integrations/sigfox`,
				`${prefix}/integrations/ocean-connect`,
				`${prefix}/integrations/tuya`,
				`${prefix}/integrations/particle`,
